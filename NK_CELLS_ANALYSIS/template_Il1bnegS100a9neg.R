...
Il1bnegS100a9neg <- function(RSO_CD49bNkp46DP,RSN_CD49bNkp46DP) {  # produces 2 color channels and the overlay
    ...
    marker1 <- "Il1b"
    marker_1_threshold <- 0.03
    marker_1_type <- "SCT"
    marker2 <- "S100a9"
    marker_2_threshold <- 0.04
    marker_2_type <- "SCT"
    
    #Filter Parameters:
    filter_data <- TRUE
    parameter_name <- "Il1bnegS100a9neg"
...
print("template_Il1bnegS100a9neg.R #########################################################################")
...
var_Il1bnegS100a9neg<-Il1bnegS100a9neg(var_RSO_CD49bNkp46DP,var_RSN_CD49bNkp46DP)
saveRDS(var_Il1bnegS100a9neg, paste0(rds_output,"/var_Il1bnegS100a9neg.rds"))
