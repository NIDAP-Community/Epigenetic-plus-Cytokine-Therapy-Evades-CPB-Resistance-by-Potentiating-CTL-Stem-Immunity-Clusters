...
RMDT_CD49bNkp46DP <- function(RSO_CD49bNkp46DP) {
...
#image: png
    png(filename="RMDT_CD49bNkp46DP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RMDT_CD49bNkp46DP.R #########################################################################")
...
var_RMDT_CD49bNkp46DP<-RMDT_CD49bNkp46DP(var_RSO_CD49bNkp46DP)
saveRDS(var_RMDT_CD49bNkp46DP, paste0(rds_output,"/var_RMDT_CD49bNkp46DP.rds"))
