...
SuppFIGURE_5A_TripletvsN803aPD1 <- function(DEGMarkers_CD49bNkp46DP) {
    # image: png
    ...
    #Basic Parameters:
    df.orig <- DEGMarkers_CD49bNkp46DP
    label.col <- "Gene"
    sig.col <- c("C_ENT+N803+aPD1_vs_N803+aPD1_pval")
    pCutoff  = 0.05
    lfc.col <- c("C_ENT+N803+aPD1_vs_N803+aPD1_logFC")
    FCcutoff = 0.585
...
print("template_SuppFIGURE_5A_TripletvsN803aPD1.R #########################################################################")
...
# Processing input variable: var_DEGMarkers_CD49bNkp46DP
var_DEGMarkers_CD49bNkp46DP<-readRDS(paste0(rds_output,"/var_DEGMarkers_CD49bNkp46DP.rds"))

if (!('Seurat' %in% class(var_DEGMarkers_CD49bNkp46DP))) { if (!(class(var_DEGMarkers_CD49bNkp46DP) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DEGMarkers_CD49bNkp46DP <- as.data.frame(var_DEGMarkers_CD49bNkp46DP)}}
#############################

# Saving Output Dataset
invisible(graphics.off())
var_SuppFIGURE_5A_TripletvsN803aPD1<-SuppFIGURE_5A_TripletvsN803aPD1(var_DEGMarkers_CD49bNkp46DP)
saveRDS(var_SuppFIGURE_5A_TripletvsN803aPD1, paste0(rds_output,"/var_SuppFIGURE_5A_TripletvsN803aPD1.rds"))
