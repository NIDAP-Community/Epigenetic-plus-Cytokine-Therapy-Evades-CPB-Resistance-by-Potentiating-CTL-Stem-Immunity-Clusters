...
FIGURE_4F <- function(DEGMarkers_CD49bNkp46DP) {
    # image: png
...
var_FIGURE_4F<-FIGURE_4F(var_DEGMarkers_CD49bNkp46DP)
saveRDS(var_FIGURE_4F, paste0(rds_output,"/var_FIGURE_4F.rds"))
