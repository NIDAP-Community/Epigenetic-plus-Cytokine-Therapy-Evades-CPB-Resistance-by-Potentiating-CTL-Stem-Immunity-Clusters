...
DEGMarkers_Il1bnegS100a9neg <- function(ReclusterSO_Il1bnegS100a9neg,SampleNames_Il1bnegS100a9neg,MetadataTable_recluster_Il1bnegS100a9neg) {
    ...
    seurat_object <- ReclusterSO_Il1bnegS100a9neg
    metadata_table <- MetadataTable_recluster_Il1bnegS100a9neg
...
# Contrasts parameters
    ...
    contrasts <- c("ENT-PBS","N803-PBS","aPD1-PBS","ENT+aPD1-PBS","ENT+N803-PBS","N803+aPD1-PBS","ENT+N803+aPD1-PBS","ENT+N803+aPD1-ENT+N803","ENT+N803+aPD1-ENT+aPD1","ENT+N803+aPD1-N803+aPD1","ENT+N803+aPD1-N803")
...
print("template_DEGMarkers_Il1bnegS100a9neg.R #########################################################################")
...
# Processing input variable: var_ReclusterSO_Il1bnegS100a9neg
var_ReclusterSO_Il1bnegS100a9neg<-readRDS(paste0(rds_output,"/var_ReclusterSO_Il1bnegS100a9neg.rds"))

if (!('Seurat' %in% class(var_ReclusterSO_Il1bnegS100a9neg))) { if (!(class(var_ReclusterSO_Il1bnegS100a9neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ReclusterSO_Il1bnegS100a9neg <- as.data.frame(var_ReclusterSO_Il1bnegS100a9neg)}}
#############################


# Processing input variable: var_SampleNames_Il1bnegS100a9neg
var_SampleNames_Il1bnegS100a9neg<-readRDS(paste0(rds_output,"/var_SampleNames_Il1bnegS100a9neg.rds"))

if (!('Seurat' %in% class(var_SampleNames_Il1bnegS100a9neg))) { if (!(class(var_SampleNames_Il1bnegS100a9neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_SampleNames_Il1bnegS100a9neg <- as.data.frame(var_SampleNames_Il1bnegS100a9neg)}}
#############################
...
var_DEGMarkers_Il1bnegS100a9neg<-DEGMarkers_Il1bnegS100a9neg(var_ReclusterSO_Il1bnegS100a9neg,var_SampleNames_Il1bnegS100a9neg,var_MetadataTable_recluster_Il1bnegS100a9neg)
saveRDS(var_DEGMarkers_Il1bnegS100a9neg, paste0(rds_output,"/var_DEGMarkers_Il1bnegS100a9neg.rds"))
