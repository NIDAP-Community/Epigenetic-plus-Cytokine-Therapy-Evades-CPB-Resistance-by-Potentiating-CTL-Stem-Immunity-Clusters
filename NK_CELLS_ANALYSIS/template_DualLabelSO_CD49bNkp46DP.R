...
DualLabelSO_CD49bNkp46DP <- function(CellTypesSO,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
    ...
    marker1 <- "Itga2"
    marker_1_threshold <- 0.022
    marker_1_type <- "SCT"
    marker2 <- "Ncr1"
    marker_2_threshold <- 0.022
    marker_2_type <- "SCT"
    
    #Filter Parameters:
    filter_data <- TRUE
    parameter_name <- "Itga2pos_ncr1pos"
...
print("template_DualLabelSO_CD49bNkp46DP.R #########################################################################")
...
var_DualLabelSO_CD49bNkp46DP<-DualLabelSO_CD49bNkp46DP(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_DualLabelSO_CD49bNkp46DP, paste0(rds_output,"/var_DualLabelSO_CD49bNkp46DP.rds"))
