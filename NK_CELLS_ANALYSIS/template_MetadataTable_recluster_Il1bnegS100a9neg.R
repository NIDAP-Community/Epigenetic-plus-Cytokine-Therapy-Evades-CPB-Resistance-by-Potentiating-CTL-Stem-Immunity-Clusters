...
MetadataTable_recluster_Il1bnegS100a9neg <- function(ReclusterSO_Il1bnegS100a9neg) {
...
#image: png
    png(filename="MetadataTable_recluster_Il1bnegS100a9neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_recluster_Il1bnegS100a9neg.R #########################################################################")
...
var_MetadataTable_recluster_Il1bnegS100a9neg<-MetadataTable_recluster_Il1bnegS100a9neg(var_ReclusterSO_Il1bnegS100a9neg)
saveRDS(var_MetadataTable_recluster_Il1bnegS100a9neg, paste0(rds_output,"/var_MetadataTable_recluster_Il1bnegS100a9neg.rds"))
