...
GSEA_Preranked1 <- function(ENTN803aPD1vsENTN803, msigdb_v6_2_with_orthologs) {
...
# Primary inputs
deg_table = ENTN803aPD1vsENTN803
...
print("template_GSEA_Preranked1.R #########################################################################")
...
var_GSEA_Preranked1<-GSEA_Preranked1(var_ENTN803aPD1vsENTN803,var_msigdb_v6_2_with_orthologs)
saveRDS(var_GSEA_Preranked1, paste0(rds_output,"/var_GSEA_Preranked1.rds"))
