...
SuppFIGURE_5A_TripletvsN803 <- function(DEGMarkers_CD49bNkp46DP) {
    # image: png
    ...
    label.col <- "Gene"
    sig.col <- c("C_ENT+N803+aPD1_vs_N803_pval")
    pCutoff  = 0.05
    lfc.col <- c("C_ENT+N803+aPD1_vs_N803_logFC")
    FCcutoff = 0.585
...
print("template_SuppFIGURE_5A_TripletvsN803.R #########################################################################")
...
var_SuppFIGURE_5A_TripletvsN803<-SuppFIGURE_5A_TripletvsN803(var_DEGMarkers_CD49bNkp46DP)
saveRDS(var_SuppFIGURE_5A_TripletvsN803, paste0(rds_output,"/var_SuppFIGURE_5A_TripletvsN803.rds"))
