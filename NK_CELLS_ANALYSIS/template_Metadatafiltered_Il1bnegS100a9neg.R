...
Metadatafiltered_Il1bnegS100a9neg <- function(FilteredSO_Il1bnegS100a9neg) {
...
#image: png
    png(filename="Metadatafiltered_Il1bnegS100a9neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_Metadatafiltered_Il1bnegS100a9neg.R #########################################################################")
...
var_Metadatafiltered_Il1bnegS100a9neg<-Metadatafiltered_Il1bnegS100a9neg(var_FilteredSO_Il1bnegS100a9neg)
saveRDS(var_Metadatafiltered_Il1bnegS100a9neg, paste0(rds_output,"/var_Metadatafiltered_Il1bnegS100a9neg.rds"))
