...
GSEA_Filtered1 <- function(GSEA_Preranked1, msigdb_v6_2_with_orthologs ) {
...
print("template_GSEA_Filtered1.R #########################################################################")
...
# Processing input variable: var_GSEA_Preranked1
var_GSEA_Preranked1<-readRDS(paste0(rds_output,"/var_GSEA_Preranked1.rds"))

if (!('Seurat' %in% class(var_GSEA_Preranked1))) { if (!(class(var_GSEA_Preranked1) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_GSEA_Preranked1 <- as.data.frame(var_GSEA_Preranked1)}}
#############################
...
var_GSEA_Filtered1<-GSEA_Filtered1(var_GSEA_Preranked1,var_msigdb_v6_2_with_orthologs)
saveRDS(var_GSEA_Filtered1, paste0(rds_output,"/var_GSEA_Filtered1.rds"))
