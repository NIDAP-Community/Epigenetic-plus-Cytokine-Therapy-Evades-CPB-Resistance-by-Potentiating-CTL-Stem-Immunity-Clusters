...
FSOMDT_CD49bNkp46DP <- function(FSO_CD49bNkp46DP) {
...
#image: png
    png(filename="FSOMDT_CD49bNkp46DP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_FSOMDT_CD49bNkp46DP.R #########################################################################")
...
var_FSOMDT_CD49bNkp46DP<-FSOMDT_CD49bNkp46DP(var_FSO_CD49bNkp46DP)
saveRDS(var_FSOMDT_CD49bNkp46DP, paste0(rds_output,"/var_FSOMDT_CD49bNkp46DP.rds"))
