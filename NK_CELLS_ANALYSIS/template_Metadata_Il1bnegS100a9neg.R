...
Metadata_Il1bnegS100a9neg <- function(Il1bnegS100a9neg) {
...
#image: png
    png(filename="Metadata_Il1bnegS100a9neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_Metadata_Il1bnegS100a9neg.R #########################################################################")
...
var_Metadata_Il1bnegS100a9neg<-Metadata_Il1bnegS100a9neg(var_Il1bnegS100a9neg)
saveRDS(var_Metadata_Il1bnegS100a9neg, paste0(rds_output,"/var_Metadata_Il1bnegS100a9neg.rds"))
