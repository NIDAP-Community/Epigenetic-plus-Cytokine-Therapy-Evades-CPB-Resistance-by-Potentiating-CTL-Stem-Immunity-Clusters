...
FSO_CD49bNkp46DP <- function(DualLabelSO_CD49bNkp46DP, DLMDT_CD49bNkp46DP, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- DualLabelSO_CD49bNkp46DP
    
    # Category parameters    
    category_to_filter <- "Itga2pos_ncr1pos"
    seed <- 10
...
print("template_FSO_CD49bNkp46DP.R #########################################################################")
...
# Processing input variable: var_DualLabelSO_CD49bNkp46DP
var_DualLabelSO_CD49bNkp46DP<-readRDS(paste0(rds_output,"/var_DualLabelSO_CD49bNkp46DP.rds"))

if (!('Seurat' %in% class(var_DualLabelSO_CD49bNkp46DP))) { if (!(class(var_DualLabelSO_CD49bNkp46DP) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DualLabelSO_CD49bNkp46DP <- as.data.frame(var_DualLabelSO_CD49bNkp46DP)}}
#############################


# Processing input variable: var_DLMDT_CD49bNkp46DP
var_DLMDT_CD49bNkp46DP<-readRDS(paste0(rds_output,"/var_DLMDT_CD49bNkp46DP.rds"))

if (!('Seurat' %in% class(var_DLMDT_CD49bNkp46DP))) { if (!(class(var_DLMDT_CD49bNkp46DP) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DLMDT_CD49bNkp46DP <- as.data.frame(var_DLMDT_CD49bNkp46DP)}}
#############################
...
var_FSO_CD49bNkp46DP<-FSO_CD49bNkp46DP(var_DualLabelSO_CD49bNkp46DP,var_DLMDT_CD49bNkp46DP,var_SampleNames_CellTypes)
saveRDS(var_FSO_CD49bNkp46DP, paste0(rds_output,"/var_FSO_CD49bNkp46DP.rds"))
