...
L2PSingle_2 <- function(DEGMarkers_Il1bnegS100a9neg) {
...
var_L2PSingle_2<-L2PSingle_2(var_DEGMarkers_Il1bnegS100a9neg)
saveRDS(var_L2PSingle_2, paste0(rds_output,"/var_L2PSingle_2.rds"))
