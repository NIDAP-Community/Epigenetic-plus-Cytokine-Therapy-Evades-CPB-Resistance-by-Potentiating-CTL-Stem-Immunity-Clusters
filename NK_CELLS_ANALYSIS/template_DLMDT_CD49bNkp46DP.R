...
DLMDT_CD49bNkp46DP <- function(DualLabelSO_CD49bNkp46DP) {
...
#image: png
    png(filename="DLMDT_CD49bNkp46DP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_DLMDT_CD49bNkp46DP.R #########################################################################")
...
var_DLMDT_CD49bNkp46DP<-DLMDT_CD49bNkp46DP(var_DualLabelSO_CD49bNkp46DP)
saveRDS(var_DLMDT_CD49bNkp46DP, paste0(rds_output,"/var_DLMDT_CD49bNkp46DP.rds"))
