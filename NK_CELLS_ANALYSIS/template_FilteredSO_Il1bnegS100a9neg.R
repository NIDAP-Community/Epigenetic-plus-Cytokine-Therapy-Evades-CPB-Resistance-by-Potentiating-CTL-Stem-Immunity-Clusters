...
FilteredSO_Il1bnegS100a9neg <- function(Il1bnegS100a9neg, Metadata_Il1bnegS100a9neg, RSN_CD49bNkp46DP) {
...
library(plotly)
    ...
    seurat_object <- Il1bnegS100a9neg
    
    # Category parameters    
    category_to_filter <- "Il1bnegS100a9neg"
    seed <- 10
...
print("template_FilteredSO_Il1bnegS100a9neg.R #########################################################################")
...
# Processing input variable: var_Il1bnegS100a9neg
var_Il1bnegS100a9neg<-readRDS(paste0(rds_output,"/var_Il1bnegS100a9neg.rds"))

if (!('Seurat' %in% class(var_Il1bnegS100a9neg))) { if (!(class(var_Il1bnegS100a9neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_Il1bnegS100a9neg <- as.data.frame(var_Il1bnegS100a9neg)}}
#############################


# Processing input variable: var_Metadata_Il1bnegS100a9neg
var_Metadata_Il1bnegS100a9neg<-readRDS(paste0(rds_output,"/var_Metadata_Il1bnegS100a9neg.rds"))

if (!('Seurat' %in% class(var_Metadata_Il1bnegS100a9neg))) { if (!(class(var_Metadata_Il1bnegS100a9neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_Metadata_Il1bnegS100a9neg <- as.data.frame(var_Metadata_Il1bnegS100a9neg)}}
#############################


# Processing input variable: var_RSN_CD49bNkp46DP
var_RSN_CD49bNkp46DP<-readRDS(paste0(rds_output,"/var_RSN_CD49bNkp46DP.rds"))

if (!('Seurat' %in% class(var_RSN_CD49bNkp46DP))) { if (!(class(var_RSN_CD49bNkp46DP) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RSN_CD49bNkp46DP <- as.data.frame(var_RSN_CD49bNkp46DP)}}
#############################

# Saving Output Dataset
invisible(graphics.off())
var_FilteredSO_Il1bnegS100a9neg<-FilteredSO_Il1bnegS100a9neg(var_Il1bnegS100a9neg,var_Metadata_Il1bnegS100a9neg,var_RSN_CD49bNkp46DP)
saveRDS(var_FilteredSO_Il1bnegS100a9neg, paste0(rds_output,"/var_FilteredSO_Il1bnegS100a9neg.rds"))
