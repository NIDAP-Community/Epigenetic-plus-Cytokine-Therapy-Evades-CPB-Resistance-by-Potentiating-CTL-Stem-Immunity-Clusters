...
ENTN803aPD1vsENTN803 <- function(DEGMarkers_Il1bnegS100a9neg) {
    # image: png
    ...
    #Basic Parameters:
    df.orig <- DEGMarkers_Il1bnegS100a9neg
    label.col <- "Gene"
...
print("template_ENTN803aPD1vsENTN803.R #########################################################################")
...
var_ENTN803aPD1vsENTN803<-ENTN803aPD1vsENTN803(var_DEGMarkers_Il1bnegS100a9neg)
saveRDS(var_ENTN803aPD1vsENTN803, paste0(rds_output,"/var_ENTN803aPD1vsENTN803.rds"))
