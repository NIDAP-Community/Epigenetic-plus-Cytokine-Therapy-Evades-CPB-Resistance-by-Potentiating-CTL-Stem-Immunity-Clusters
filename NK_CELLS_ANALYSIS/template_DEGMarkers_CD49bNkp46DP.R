...
DEGMarkers_CD49bNkp46DP <- function(RSO_CD49bNkp46DP,RSN_CD49bNkp46DP,RMDT_CD49bNkp46DP) {
    ...
    metadata_table <- RMDT_CD49bNkp46DP
...
print("template_DEGMarkers_CD49bNkp46DP.R #########################################################################")
...
# Processing input variable: var_RMDT_CD49bNkp46DP
var_RMDT_CD49bNkp46DP<-readRDS(paste0(rds_output,"/var_RMDT_CD49bNkp46DP.rds"))

if (!('Seurat' %in% class(var_RMDT_CD49bNkp46DP))) { if (!(class(var_RMDT_CD49bNkp46DP) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RMDT_CD49bNkp46DP <- as.data.frame(var_RMDT_CD49bNkp46DP)}}
#############################

# Saving Output Dataset
invisible(graphics.off())
var_DEGMarkers_CD49bNkp46DP<-DEGMarkers_CD49bNkp46DP(var_RSO_CD49bNkp46DP,var_RSN_CD49bNkp46DP,var_RMDT_CD49bNkp46DP)
saveRDS(var_DEGMarkers_CD49bNkp46DP, paste0(rds_output,"/var_DEGMarkers_CD49bNkp46DP.rds"))
