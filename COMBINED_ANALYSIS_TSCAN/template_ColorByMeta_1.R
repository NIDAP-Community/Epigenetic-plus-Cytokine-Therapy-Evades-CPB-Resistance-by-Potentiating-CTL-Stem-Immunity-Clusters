...
ColorByMeta_1 <- function(RSO_ExcludeNK_CD8Tcells,RSN_ExcludeNK_CD8Tcells,RMDT_ExcludeNK_CD8Tcells) {
...
print("template_ColorByMeta_1.R #########################################################################")
...
var_ColorByMeta_1<-ColorByMeta_1(var_RSO_ExcludeNK_CD8Tcells,var_RSN_ExcludeNK_CD8Tcells,var_RMDT_ExcludeNK_CD8Tcells)
saveRDS(var_ColorByMeta_1, paste0(rds_output,"/var_ColorByMeta_1.rds"))
