...
ColorByMeta_3 <- function(ReclusterSO_1,SampleNames_2,MetadataTable_8) {
    ...
    Samples_to_Include <- 'c("LN_ENT+N803","T_ENT+N803")'
...
print("template_ColorByMeta_3.R #########################################################################")
...
var_ColorByMeta_3<-ColorByMeta_3(var_ReclusterSO_1,var_SampleNames_2,var_MetadataTable_8)
saveRDS(var_ColorByMeta_3, paste0(rds_output,"/var_ColorByMeta_3.rds"))
