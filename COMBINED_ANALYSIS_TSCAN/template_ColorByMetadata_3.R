...
ColorByMetadata_3 <- function(RSO_ExcludeNK_CD8Tcells,RSN_ExcludeNK_CD8Tcells,RMDT_ExcludeNK_CD8Tcells) {
    ...
    Samples_to_Include <- 'c("T_ENT+N803+aPD1","LN_ENT+N803+aPD1")'
    Metadata_to_Plot <- 'c("SCT_snn_res_0_8")'
...
print("template_ColorByMetadata_3.R #########################################################################")
...
var_ColorByMetadata_3<-ColorByMetadata_3(var_RSO_ExcludeNK_CD8Tcells,var_RSN_ExcludeNK_CD8Tcells,var_RMDT_ExcludeNK_CD8Tcells)
saveRDS(var_ColorByMetadata_3, paste0(rds_output,"/var_ColorByMetadata_3.rds"))
