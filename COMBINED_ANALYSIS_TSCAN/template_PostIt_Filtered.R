...
#image: png
    png(filename="PostIt_Filtered.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_Filtered.R #########################################################################")
...
var_PostIt_Filtered<-PostIt_Filtered()
saveRDS(var_PostIt_Filtered, paste0(rds_output,"/var_PostIt_Filtered.rds"))
