...
FSO_CD3CD8_Tcells <- function(DualLabelSO_CD3CD8_Tcells, MDT_DL_CD3CD8_Tcells, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- DualLabelSO_CD3CD8_Tcells
    
    # Category parameters    
    category_to_filter <- "Cd8a_Cd3e_CoExp"
    seed <- 10
...
print("template_FSO_CD3CD8_Tcells.R #########################################################################")
...
# Processing input variable: var_DualLabelSO_CD3CD8_Tcells
var_DualLabelSO_CD3CD8_Tcells<-readRDS(paste0(rds_output,"/var_DualLabelSO_CD3CD8_Tcells.rds"))

if (!('Seurat' %in% class(var_DualLabelSO_CD3CD8_Tcells))) { if (!(class(var_DualLabelSO_CD3CD8_Tcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DualLabelSO_CD3CD8_Tcells <- as.data.frame(var_DualLabelSO_CD3CD8_Tcells)}}
#############################


# Processing input variable: var_MDT_DL_CD3CD8_Tcells
var_MDT_DL_CD3CD8_Tcells<-readRDS(paste0(rds_output,"/var_MDT_DL_CD3CD8_Tcells.rds"))

if (!('Seurat' %in% class(var_MDT_DL_CD3CD8_Tcells))) { if (!(class(var_MDT_DL_CD3CD8_Tcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MDT_DL_CD3CD8_Tcells <- as.data.frame(var_MDT_DL_CD3CD8_Tcells)}}
#############################
...
var_FSO_CD3CD8_Tcells<-FSO_CD3CD8_Tcells(var_DualLabelSO_CD3CD8_Tcells,var_MDT_DL_CD3CD8_Tcells,var_SampleNames_CellTypes)
saveRDS(var_FSO_CD3CD8_Tcells, paste0(rds_output,"/var_FSO_CD3CD8_Tcells.rds"))
