...
SubsettedSO <- function(RSO_ExcludeNK_CD8Tcells, RMDT_ExcludeNK_CD8Tcells, RSN_ExcludeNK_CD8Tcells) {
...
library(plotly)
    ...
    # Category parameters    
    category_to_filter <- "SCT_snn_res_0_8"
    seed <- 10
...
var_SubsettedSO<-SubsettedSO(var_RSO_ExcludeNK_CD8Tcells,var_RMDT_ExcludeNK_CD8Tcells,var_RSN_ExcludeNK_CD8Tcells)
saveRDS(var_SubsettedSO, paste0(rds_output,"/var_SubsettedSO.rds"))
