...
DEGMarkers <- function(RSO_ExcludeNK_CD8Tcells,RSN_ExcludeNK_CD8Tcells,RMDT_ExcludeNK_CD8Tcells) {
...
var_DEGMarkers<-DEGMarkers(var_RSO_ExcludeNK_CD8Tcells,var_RSN_ExcludeNK_CD8Tcells,var_RMDT_ExcludeNK_CD8Tcells)
