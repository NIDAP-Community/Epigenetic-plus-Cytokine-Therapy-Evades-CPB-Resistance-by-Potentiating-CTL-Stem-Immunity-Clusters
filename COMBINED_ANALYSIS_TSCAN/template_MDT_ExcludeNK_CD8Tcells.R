...
MDT_ExcludeNK_CD8Tcells <- function(ExcludeNK_CD8Tcells) {
...
#image: png
    png(filename="MDT_ExcludeNK_CD8Tcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MDT_ExcludeNK_CD8Tcells.R #########################################################################")
...
var_MDT_ExcludeNK_CD8Tcells<-MDT_ExcludeNK_CD8Tcells(var_ExcludeNK_CD8Tcells)
saveRDS(var_MDT_ExcludeNK_CD8Tcells, paste0(rds_output,"/var_MDT_ExcludeNK_CD8Tcells.rds"))
