...
MetadataTable_8 <- function(ReclusterSO_1) {
...
#image: png
    png(filename="MetadataTable_8.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_8.R #########################################################################")
...
var_MetadataTable_8<-MetadataTable_8(var_ReclusterSO_1)
saveRDS(var_MetadataTable_8, paste0(rds_output,"/var_MetadataTable_8.rds"))
