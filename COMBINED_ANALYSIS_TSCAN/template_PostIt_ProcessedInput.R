...
PostIt_ProcessedInput <- function() {
...
#image: png
    png(filename="PostIt_ProcessedInput.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_ProcessedInput.R #########################################################################")
...
var_PostIt_ProcessedInput<-PostIt_ProcessedInput()
saveRDS(var_PostIt_ProcessedInput, paste0(rds_output,"/var_PostIt_ProcessedInput.rds"))
