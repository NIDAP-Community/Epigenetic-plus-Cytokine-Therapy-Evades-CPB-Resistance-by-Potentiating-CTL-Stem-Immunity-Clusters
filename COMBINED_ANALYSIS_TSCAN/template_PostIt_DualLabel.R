...
PostIt_DualLabel <- function() {

library(ggplot2)

# text params

    text = "CD8_CD3/nDual label"
    text_color = 'Black'
    text_size = 80
    text_fontface = "plain"
...
#image: png
    png(filename="PostIt_DualLabel.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_DualLabel.R #########################################################################")
...
var_PostIt_DualLabel<-PostIt_DualLabel()
saveRDS(var_PostIt_DualLabel, paste0(rds_output,"/var_PostIt_DualLabel.rds"))
