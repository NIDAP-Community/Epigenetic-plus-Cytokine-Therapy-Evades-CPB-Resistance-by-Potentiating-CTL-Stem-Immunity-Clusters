...
ColorByMetadata_1 <- function(RSO_ExcludeNK_CD8Tcells,RSN_ExcludeNK_CD8Tcells,RMDT_ExcludeNK_CD8Tcells) {
    ...
    Samples_to_Include <- 'c("LN_PBS","T_PBS")'
...
print("template_ColorByMetadata_1.R #########################################################################")
...
var_ColorByMetadata_1<-ColorByMetadata_1(var_RSO_ExcludeNK_CD8Tcells,var_RSN_ExcludeNK_CD8Tcells,var_RMDT_ExcludeNK_CD8Tcells)
saveRDS(var_ColorByMetadata_1, paste0(rds_output,"/var_ColorByMetadata_1.rds"))
