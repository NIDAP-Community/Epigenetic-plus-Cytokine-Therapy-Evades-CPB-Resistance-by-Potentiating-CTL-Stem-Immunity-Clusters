...
SampleNames_CellTypes <- function(CellTypesSO) {
...
#image: png
    png(filename="SampleNames_CellTypes.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_SampleNames_CellTypes.R #########################################################################")
...
var_SampleNames_CellTypes<-SampleNames_CellTypes(var_CellTypesSO)
saveRDS(var_SampleNames_CellTypes, paste0(rds_output,"/var_SampleNames_CellTypes.rds"))
