...
ColorByMeta_5 <- function(ReclusterSO_1,SampleNames_2,MetadataTable_8) {
    ...
    Samples_to_Include <- 'c("LN_ENT+aPD1","T_ENT+aPD1")'
...
print("template_ColorByMeta_5.R #########################################################################")
...
var_ColorByMeta_5<-ColorByMeta_5(var_ReclusterSO_1,var_SampleNames_2,var_MetadataTable_8)
saveRDS(var_ColorByMeta_5, paste0(rds_output,"/var_ColorByMeta_5.rds"))
