...
SampleNames_2 <- function(ReclusterSO_1) {
...
#image: png
    png(filename="SampleNames_2.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_SampleNames_2.R #########################################################################")
...
var_SampleNames_2<-SampleNames_2(var_ReclusterSO_1)
saveRDS(var_SampleNames_2, paste0(rds_output,"/var_SampleNames_2.rds"))
