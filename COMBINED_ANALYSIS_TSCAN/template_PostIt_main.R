...
PostIt_main <- function() {

library(ggplot2)

# text params

    text = "COMBINED LN and Tumor Workbook"
    text_color = 'Black'
    text_size = 40
    text_fontface = "plain"
...
#image: png
    png(filename="PostIt_main.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
var_PostIt_main<-PostIt_main()
saveRDS(var_PostIt_main, paste0(rds_output,"/var_PostIt_main.rds"))
