...
MetadataTable_7 <- function(SubsettedSO) {
...
#image: png
    png(filename="MetadataTable_7.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_7.R #########################################################################")
...
var_MetadataTable_7<-MetadataTable_7(var_SubsettedSO)
saveRDS(var_MetadataTable_7, paste0(rds_output,"/var_MetadataTable_7.rds"))
