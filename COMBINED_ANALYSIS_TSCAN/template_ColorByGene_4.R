...
ColorByGene_4 <- function(RSO_ExcludeNK_CD8Tcells,RSN_ExcludeNK_CD8Tcells) {
...
print("template_ColorByGene_4.R #########################################################################")
...
var_ColorByGene_4<-ColorByGene_4(var_RSO_ExcludeNK_CD8Tcells,var_RSN_ExcludeNK_CD8Tcells)
saveRDS(var_ColorByGene_4, paste0(rds_output,"/var_ColorByGene_4.rds"))
