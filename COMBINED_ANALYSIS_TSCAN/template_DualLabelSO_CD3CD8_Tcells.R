...
DualLabelSO_CD3CD8_Tcells <- function(CellTypesSO,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
    ...
    #Filter Parameters:
    filter_data <- TRUE
    parameter_name <- "Cd8a_Cd3e_CoExp"
...
print("template_DualLabelSO_CD3CD8_Tcells.R #########################################################################")
...
var_DualLabelSO_CD3CD8_Tcells<-DualLabelSO_CD3CD8_Tcells(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_DualLabelSO_CD3CD8_Tcells, paste0(rds_output,"/var_DualLabelSO_CD3CD8_Tcells.rds"))
