...
FSO_ExcludeNK_CD8Tcells <- function(ExcludeNK_CD8Tcells, MDT_ExcludeNK_CD8Tcells, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- ExcludeNK_CD8Tcells
    
    # Category parameters    
    category_to_filter <- "Cd49b_Cd4_neg"
    seed <- 10
...
print("template_FSO_ExcludeNK_CD8Tcells.R #########################################################################")
...
# Processing input variable: var_ExcludeNK_CD8Tcells
var_ExcludeNK_CD8Tcells<-readRDS(paste0(rds_output,"/var_ExcludeNK_CD8Tcells.rds"))

if (!('Seurat' %in% class(var_ExcludeNK_CD8Tcells))) { if (!(class(var_ExcludeNK_CD8Tcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ExcludeNK_CD8Tcells <- as.data.frame(var_ExcludeNK_CD8Tcells)}}
#############################


# Processing input variable: var_MDT_ExcludeNK_CD8Tcells
var_MDT_ExcludeNK_CD8Tcells<-readRDS(paste0(rds_output,"/var_MDT_ExcludeNK_CD8Tcells.rds"))

if (!('Seurat' %in% class(var_MDT_ExcludeNK_CD8Tcells))) { if (!(class(var_MDT_ExcludeNK_CD8Tcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MDT_ExcludeNK_CD8Tcells <- as.data.frame(var_MDT_ExcludeNK_CD8Tcells)}}
#############################
...
var_FSO_ExcludeNK_CD8Tcells<-FSO_ExcludeNK_CD8Tcells(var_ExcludeNK_CD8Tcells,var_MDT_ExcludeNK_CD8Tcells,var_SampleNames_CellTypes)
saveRDS(var_FSO_ExcludeNK_CD8Tcells, paste0(rds_output,"/var_FSO_ExcludeNK_CD8Tcells.rds"))
