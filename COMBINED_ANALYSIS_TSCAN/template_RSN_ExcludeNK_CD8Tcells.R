...
RSN_ExcludeNK_CD8Tcells <- function(RSO_ExcludeNK_CD8Tcells) {
...
#image: png
    png(filename="RSN_ExcludeNK_CD8Tcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RSN_ExcludeNK_CD8Tcells.R #########################################################################")
...
var_RSN_ExcludeNK_CD8Tcells<-RSN_ExcludeNK_CD8Tcells(var_RSO_ExcludeNK_CD8Tcells)
saveRDS(var_RSN_ExcludeNK_CD8Tcells, paste0(rds_output,"/var_RSN_ExcludeNK_CD8Tcells.rds"))
