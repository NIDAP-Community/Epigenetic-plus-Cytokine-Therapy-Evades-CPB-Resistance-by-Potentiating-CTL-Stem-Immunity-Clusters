...
FMDT_ExcludeNK_CD8Tcells <- function(FSO_ExcludeNK_CD8Tcells) {
...
#image: png
    png(filename="FMDT_ExcludeNK_CD8Tcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_FMDT_ExcludeNK_CD8Tcells.R #########################################################################")
...
var_FMDT_ExcludeNK_CD8Tcells<-FMDT_ExcludeNK_CD8Tcells(var_FSO_ExcludeNK_CD8Tcells)
saveRDS(var_FMDT_ExcludeNK_CD8Tcells, paste0(rds_output,"/var_FMDT_ExcludeNK_CD8Tcells.rds"))
