...
RMDT_Cd19posCd3neg <- function(ReclusterSO_Cd19posCd3neg) {
...
#image: png
    png(filename="RMDT_Cd19posCd3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RMDT_Cd19posCd3neg.R #########################################################################")
...
var_RMDT_Cd19posCd3neg<-RMDT_Cd19posCd3neg(var_ReclusterSO_Cd19posCd3neg)
saveRDS(var_RMDT_Cd19posCd3neg, paste0(rds_output,"/var_RMDT_Cd19posCd3neg.rds"))
