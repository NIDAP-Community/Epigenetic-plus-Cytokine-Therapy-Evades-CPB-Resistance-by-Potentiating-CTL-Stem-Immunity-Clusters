...
Filteredso_B_Cells <- function(CellTypesSO, MetadataTable_CellTypes, SampleNames_CellTypes) {
...
library(plotly)
    ...
    keep_or_remove <- TRUE
    values_to_filter <- c("B cells","B cells, pro")
...
print("template_Filteredso_B_Cells.R #########################################################################")
...
var_Filteredso_B_Cells<-Filteredso_B_Cells(var_CellTypesSO,var_MetadataTable_CellTypes,var_SampleNames_CellTypes)
saveRDS(var_Filteredso_B_Cells, paste0(rds_output,"/var_Filteredso_B_Cells.rds"))
