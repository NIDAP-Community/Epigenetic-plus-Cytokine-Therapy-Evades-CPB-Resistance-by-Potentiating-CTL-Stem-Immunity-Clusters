...
DP_Bcells <- function(CellTypesSO,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
...
var_DP_Bcells<-DP_Bcells(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_DP_Bcells, paste0(rds_output,"/var_DP_Bcells.rds"))
