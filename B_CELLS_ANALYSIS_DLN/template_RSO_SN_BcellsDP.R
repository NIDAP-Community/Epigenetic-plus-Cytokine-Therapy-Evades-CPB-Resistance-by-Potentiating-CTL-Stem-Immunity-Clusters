...
RSO_SN_BcellsDP <- function(ReclusterSO1) {
...
#image: png
    png(filename="RSO_SN_BcellsDP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RSO_SN_BcellsDP.R #########################################################################")
...
var_RSO_SN_BcellsDP<-RSO_SN_BcellsDP(var_ReclusterSO1)
saveRDS(var_RSO_SN_BcellsDP, paste0(rds_output,"/var_RSO_SN_BcellsDP.rds"))
