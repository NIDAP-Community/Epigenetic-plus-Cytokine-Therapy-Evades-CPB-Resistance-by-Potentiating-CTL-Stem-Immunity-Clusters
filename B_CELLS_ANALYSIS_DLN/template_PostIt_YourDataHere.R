...
#image: png
    png(filename="PostIt_YourDataHere.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_YourDataHere.R #########################################################################")
...
var_PostIt_YourDataHere<-PostIt_YourDataHere()
saveRDS(var_PostIt_YourDataHere, paste0(rds_output,"/var_PostIt_YourDataHere.rds"))
