...
RSO_MDT_BcellsDP <- function(ReclusterSO1) {
...
#image: png
    png(filename="RSO_MDT_BcellsDP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RSO_MDT_BcellsDP.R #########################################################################")
...
var_RSO_MDT_BcellsDP<-RSO_MDT_BcellsDP(var_ReclusterSO1)
saveRDS(var_RSO_MDT_BcellsDP, paste0(rds_output,"/var_RSO_MDT_BcellsDP.rds"))
