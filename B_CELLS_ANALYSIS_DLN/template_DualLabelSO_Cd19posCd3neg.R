...
DualLabelSO_Cd19posCd3neg <- function(CellTypesSO,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
...
print("template_DualLabelSO_Cd19posCd3neg.R #########################################################################")
...
var_DualLabelSO_Cd19posCd3neg<-DualLabelSO_Cd19posCd3neg(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_DualLabelSO_Cd19posCd3neg, paste0(rds_output,"/var_DualLabelSO_Cd19posCd3neg.rds"))
