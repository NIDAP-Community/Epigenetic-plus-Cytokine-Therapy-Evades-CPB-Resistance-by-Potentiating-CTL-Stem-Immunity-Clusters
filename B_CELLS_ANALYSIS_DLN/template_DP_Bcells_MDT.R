...
DP_Bcells_MDT <- function(DP_Bcells) {
...
#image: png
    png(filename="DP_Bcells_MDT.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_DP_Bcells_MDT.R #########################################################################")
...
var_DP_Bcells_MDT<-DP_Bcells_MDT(var_DP_Bcells)
saveRDS(var_DP_Bcells_MDT, paste0(rds_output,"/var_DP_Bcells_MDT.rds"))
