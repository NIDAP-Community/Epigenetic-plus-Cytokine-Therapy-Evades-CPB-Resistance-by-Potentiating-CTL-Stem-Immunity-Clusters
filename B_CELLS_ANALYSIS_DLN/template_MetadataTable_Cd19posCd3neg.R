...
MetadataTable_Cd19posCd3neg <- function(DualLabelSO_Cd19posCd3neg) {
...
#image: png
    png(filename="MetadataTable_Cd19posCd3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_Cd19posCd3neg.R #########################################################################")
...
var_MetadataTable_Cd19posCd3neg<-MetadataTable_Cd19posCd3neg(var_DualLabelSO_Cd19posCd3neg)
saveRDS(var_MetadataTable_Cd19posCd3neg, paste0(rds_output,"/var_MetadataTable_Cd19posCd3neg.rds"))
