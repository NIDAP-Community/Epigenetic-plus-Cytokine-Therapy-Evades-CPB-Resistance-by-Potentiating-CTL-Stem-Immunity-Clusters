...
FilteredDPB_MDT <- function(DP_Bcells_FilteredSO) {
...
#image: png
    png(filename="FilteredDPB_MDT.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_FilteredDPB_MDT.R #########################################################################")
...
var_FilteredDPB_MDT<-FilteredDPB_MDT(var_DP_Bcells_FilteredSO)
saveRDS(var_FilteredDPB_MDT, paste0(rds_output,"/var_FilteredDPB_MDT.rds"))
