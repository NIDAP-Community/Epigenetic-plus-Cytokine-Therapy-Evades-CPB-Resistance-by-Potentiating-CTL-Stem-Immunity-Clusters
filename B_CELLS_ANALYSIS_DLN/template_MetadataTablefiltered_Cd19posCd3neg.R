...
MetadataTablefiltered_Cd19posCd3neg <- function(FilteredSO_Cd19posCd3neg) {
...
#image: png
    png(filename="MetadataTablefiltered_Cd19posCd3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTablefiltered_Cd19posCd3neg.R #########################################################################")
...
var_MetadataTablefiltered_Cd19posCd3neg<-MetadataTablefiltered_Cd19posCd3neg(var_FilteredSO_Cd19posCd3neg)
saveRDS(var_MetadataTablefiltered_Cd19posCd3neg, paste0(rds_output,"/var_MetadataTablefiltered_Cd19posCd3neg.rds"))
