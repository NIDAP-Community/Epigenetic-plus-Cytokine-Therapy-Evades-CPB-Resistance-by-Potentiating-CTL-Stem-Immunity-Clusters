...
FilteredSO_Cd19posCd3neg <- function(DualLabelSO_Cd19posCd3neg, MetadataTable_Cd19posCd3neg, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- DualLabelSO_Cd19posCd3neg
    
    # Category parameters    
    category_to_filter <- "Cd19posCd3neg"
    seed <- 10
...
print("template_FilteredSO_Cd19posCd3neg.R #########################################################################")
...
# Processing input variable: var_DualLabelSO_Cd19posCd3neg
var_DualLabelSO_Cd19posCd3neg<-readRDS(paste0(rds_output,"/var_DualLabelSO_Cd19posCd3neg.rds"))

if (!('Seurat' %in% class(var_DualLabelSO_Cd19posCd3neg))) { if (!(class(var_DualLabelSO_Cd19posCd3neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DualLabelSO_Cd19posCd3neg <- as.data.frame(var_DualLabelSO_Cd19posCd3neg)}}
#############################


# Processing input variable: var_MetadataTable_Cd19posCd3neg
var_MetadataTable_Cd19posCd3neg<-readRDS(paste0(rds_output,"/var_MetadataTable_Cd19posCd3neg.rds"))

if (!('Seurat' %in% class(var_MetadataTable_Cd19posCd3neg))) { if (!(class(var_MetadataTable_Cd19posCd3neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MetadataTable_Cd19posCd3neg <- as.data.frame(var_MetadataTable_Cd19posCd3neg)}}
#############################
...
var_FilteredSO_Cd19posCd3neg<-FilteredSO_Cd19posCd3neg(var_DualLabelSO_Cd19posCd3neg,var_MetadataTable_Cd19posCd3neg,var_SampleNames_CellTypes)
saveRDS(var_FilteredSO_Cd19posCd3neg, paste0(rds_output,"/var_FilteredSO_Cd19posCd3neg.rds"))
