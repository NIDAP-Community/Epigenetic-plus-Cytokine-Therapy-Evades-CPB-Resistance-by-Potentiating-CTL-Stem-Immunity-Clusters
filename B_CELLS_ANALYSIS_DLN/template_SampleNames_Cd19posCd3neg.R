...
SampleNames_Cd19posCd3neg <- function(ReclusterSO_Cd19posCd3neg) {
...
#image: png
    png(filename="SampleNames_Cd19posCd3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_SampleNames_Cd19posCd3neg.R #########################################################################")
...
var_SampleNames_Cd19posCd3neg<-SampleNames_Cd19posCd3neg(var_ReclusterSO_Cd19posCd3neg)
saveRDS(var_SampleNames_Cd19posCd3neg, paste0(rds_output,"/var_SampleNames_Cd19posCd3neg.rds"))
