...
#image: png
    png(filename="PostIt_ModScore.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_ModScore.R #########################################################################")
...
var_PostIt_ModScore<-PostIt_ModScore()
saveRDS(var_PostIt_ModScore, paste0(rds_output,"/var_PostIt_ModScore.rds"))
