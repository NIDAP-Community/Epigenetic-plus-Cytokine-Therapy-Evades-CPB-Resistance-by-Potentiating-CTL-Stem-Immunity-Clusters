...
#image: png
    png(filename="PostIt_ColorByGene.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_ColorByGene.R #########################################################################")
...
var_PostIt_ColorByGene<-PostIt_ColorByGene()
saveRDS(var_PostIt_ColorByGene, paste0(rds_output,"/var_PostIt_ColorByGene.rds"))
