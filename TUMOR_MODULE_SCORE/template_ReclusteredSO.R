...
ReclusteredSO <- function(FilteredSO, MetadataTable_Filtered_9_10) {
    #image: png
...
print("template_ReclusteredSO.R #########################################################################")
...
var_ReclusteredSO<-ReclusteredSO(var_FilteredSO,var_MetadataTable_Filtered_9_10)
saveRDS(var_ReclusteredSO, paste0(rds_output,"/var_ReclusteredSO.rds"))
