...
SuppFIGURE_5Bpart3 <- function(CellTypesSO,SampleNames_CellTypes) {
    ...
    gene <- c("Ly6a","Itgax","Nos2","Cxcr5","Foxp3","Tcf7","Cd86","Cd79b")
...
print("template_SuppFIGURE_5Bpart3.R #########################################################################")
...
var_SuppFIGURE_5Bpart3<-SuppFIGURE_5Bpart3(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_SuppFIGURE_5Bpart3, paste0(rds_output,"/var_SuppFIGURE_5Bpart3.rds"))
