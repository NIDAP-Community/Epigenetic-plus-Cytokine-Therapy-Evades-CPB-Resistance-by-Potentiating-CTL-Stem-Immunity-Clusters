...
PostIt_Reclustered <- function() {

library(ggplot2)

# text params

    text = " Recluster Cells\nAfter Filter"
    text_color = 'Black'
    text_size = 80
    text_fontface = "plain"
...
#image: png
    png(filename="PostIt_Reclustered.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_Reclustered.R #########################################################################")
...
var_PostIt_Reclustered<-PostIt_Reclustered()
saveRDS(var_PostIt_Reclustered, paste0(rds_output,"/var_PostIt_Reclustered.rds"))
