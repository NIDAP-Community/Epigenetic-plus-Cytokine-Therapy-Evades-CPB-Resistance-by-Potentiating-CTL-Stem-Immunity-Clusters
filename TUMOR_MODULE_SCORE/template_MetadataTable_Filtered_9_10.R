...
MetadataTable_Filtered_9_10 <- function(FilteredSO) {
...
#image: png
    png(filename="MetadataTable_Filtered_9_10.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_Filtered_9_10.R #########################################################################")
...
var_MetadataTable_Filtered_9_10<-MetadataTable_Filtered_9_10(var_FilteredSO)
saveRDS(var_MetadataTable_Filtered_9_10, paste0(rds_output,"/var_MetadataTable_Filtered_9_10.rds"))
