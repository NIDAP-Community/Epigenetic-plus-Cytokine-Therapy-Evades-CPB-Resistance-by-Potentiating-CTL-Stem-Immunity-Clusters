...
MetadataTable_ModScore <- function(ModScoreSO) {
...
#image: png
    png(filename="MetadataTable_ModScore.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_ModScore.R #########################################################################")
...
var_MetadataTable_ModScore<-MetadataTable_ModScore(var_ModScoreSO)
saveRDS(var_MetadataTable_ModScore, paste0(rds_output,"/var_MetadataTable_ModScore.rds"))
