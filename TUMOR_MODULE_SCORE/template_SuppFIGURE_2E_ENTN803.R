...
SuppFIGURE_2E_ENTN803 <- function(ModScoreSO,SampleNames_CellTypes,MetadataTable_ModScore) {
...
print("template_SuppFIGURE_2E_ENTN803.R #########################################################################")
...
var_SuppFIGURE_2E_ENTN803<-SuppFIGURE_2E_ENTN803(var_ModScoreSO,var_SampleNames_CellTypes,var_MetadataTable_ModScore)
saveRDS(var_SuppFIGURE_2E_ENTN803, paste0(rds_output,"/var_SuppFIGURE_2E_ENTN803.rds"))
