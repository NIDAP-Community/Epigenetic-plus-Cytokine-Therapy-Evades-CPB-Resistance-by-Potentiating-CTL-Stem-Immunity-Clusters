...
SuppFIGURE_5Bpart2 <- function(CellTypesSO,SampleNames_CellTypes) {
    ...
    gene <- c("Ifng","Tnf","Ccl5","Cxcl9","Cxcl13","Ccl22","Xcl1","Itgae")
...
print("template_SuppFIGURE_5Bpart2.R #########################################################################")
...
var_SuppFIGURE_5Bpart2<-SuppFIGURE_5Bpart2(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_SuppFIGURE_5Bpart2, paste0(rds_output,"/var_SuppFIGURE_5Bpart2.rds"))
