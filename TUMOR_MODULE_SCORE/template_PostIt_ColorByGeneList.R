...
PostIt_ColorByGeneList <- function() {
...
#image: png
    png(filename="PostIt_ColorByGeneList.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_ColorByGeneList.R #########################################################################")
...
var_PostIt_ColorByGeneList<-PostIt_ColorByGeneList()
saveRDS(var_PostIt_ColorByGeneList, paste0(rds_output,"/var_PostIt_ColorByGeneList.rds"))
