...
MetadataTable_NameClusters <- function(NameClustersSO) {
...
#image: png
    png(filename="MetadataTable_NameClusters.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_NameClusters.R #########################################################################")
...
var_MetadataTable_NameClusters<-MetadataTable_NameClusters(var_NameClustersSO)
saveRDS(var_MetadataTable_NameClusters, paste0(rds_output,"/var_MetadataTable_NameClusters.rds"))
