...
PostIt_GenesClusters <- function() {

library(ggplot2)

# text params

    text = "Plot Clusters By\nGene Expression"
    text_color = 'Black'
    text_size = 80
    text_fontface = "plain"
...
#image: png
    png(filename="PostIt_GenesClusters.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_GenesClusters.R #########################################################################")
...
var_PostIt_GenesClusters<-PostIt_GenesClusters()
saveRDS(var_PostIt_GenesClusters, paste0(rds_output,"/var_PostIt_GenesClusters.rds"))
