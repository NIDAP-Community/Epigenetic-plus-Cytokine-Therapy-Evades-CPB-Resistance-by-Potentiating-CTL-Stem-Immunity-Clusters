...
SuppFIGURE_5Bpart1 <- function(CellTypesSO,SampleNames_CellTypes) {
    ...
    gene <- c("Cd4","Cd8a","Cd19","Itga2","Clec9a","Ncr1","Mrc1","Nos2")
...
print("template_SuppFIGURE_5Bpart1.R #########################################################################")
...
var_SuppFIGURE_5Bpart1<-SuppFIGURE_5Bpart1(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_SuppFIGURE_5Bpart1, paste0(rds_output,"/var_SuppFIGURE_5Bpart1.rds"))
