...
SuppFIGURE_2E_aPD1 <- function(ModScoreSO,SampleNames_CellTypes,MetadataTable_ModScore) {
...
print("template_SuppFIGURE_2E_aPD1.R #########################################################################")
...
var_SuppFIGURE_2E_aPD1<-SuppFIGURE_2E_aPD1(var_ModScoreSO,var_SampleNames_CellTypes,var_MetadataTable_ModScore)
saveRDS(var_SuppFIGURE_2E_aPD1, paste0(rds_output,"/var_SuppFIGURE_2E_aPD1.rds"))
