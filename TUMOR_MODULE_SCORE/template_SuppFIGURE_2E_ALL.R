...
SuppFIGURE_2E_ALL <- function(ModScoreSO,SampleNames_CellTypes,MetadataTable_ModScore) {
...
print("template_SuppFIGURE_2E_ALL.R #########################################################################")
...
var_SuppFIGURE_2E_ALL<-SuppFIGURE_2E_ALL(var_ModScoreSO,var_SampleNames_CellTypes,var_MetadataTable_ModScore)
saveRDS(var_SuppFIGURE_2E_ALL, paste0(rds_output,"/var_SuppFIGURE_2E_ALL.rds"))
