...
PostIt_NameClusters <- function() {

library(ggplot2)

# text params

    text = " Rename Clusters &\nPlot Clusters By\nModule Score"
    text_color = 'Black'
    text_size = 60
    text_fontface = "plain"
...
#image: png
    png(filename="PostIt_NameClusters.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_NameClusters.R #########################################################################")
...
var_PostIt_NameClusters<-PostIt_NameClusters()
saveRDS(var_PostIt_NameClusters, paste0(rds_output,"/var_PostIt_NameClusters.rds"))
