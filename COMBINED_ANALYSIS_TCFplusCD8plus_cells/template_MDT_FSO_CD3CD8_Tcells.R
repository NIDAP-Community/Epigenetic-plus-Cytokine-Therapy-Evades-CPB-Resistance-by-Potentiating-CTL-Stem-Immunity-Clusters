...
MDT_FSO_CD3CD8_Tcells <- function(FSO_CD3CD8_Tcells) {
...
#image: png
    png(filename="MDT_FSO_CD3CD8_Tcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MDT_FSO_CD3CD8_Tcells.R #########################################################################")
...
var_MDT_FSO_CD3CD8_Tcells<-MDT_FSO_CD3CD8_Tcells(var_FSO_CD3CD8_Tcells)
saveRDS(var_MDT_FSO_CD3CD8_Tcells, paste0(rds_output,"/var_MDT_FSO_CD3CD8_Tcells.rds"))
