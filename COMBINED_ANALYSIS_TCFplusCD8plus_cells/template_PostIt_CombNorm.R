...
PostIt_CombNorm <- function() {

library(ggplot2)

# text params

    text = "Combine, Cluster\n& Normalize"
    text_color = 'Black'
    text_size = 80
    text_fontface = "plain"
...
#image: png
    png(filename="PostIt_CombNorm.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_CombNorm.R #########################################################################")
...
var_PostIt_CombNorm<-PostIt_CombNorm()
saveRDS(var_PostIt_CombNorm, paste0(rds_output,"/var_PostIt_CombNorm.rds"))
