...
Cd44posGzmbneg_DEG <- function(RSO_Cd44posGzmbneg,RSN_Cd44posGzmbneg,RMDT_Cd44posGzmbneg) {
    ...
    seurat_object <- RSO_Cd44posGzmbneg
    metadata_table <- RMDT_Cd44posGzmbneg
...
print("template_Cd44posGzmbneg_DEG.R #########################################################################")
...
# Processing input variable: var_RSO_Cd44posGzmbneg
var_RSO_Cd44posGzmbneg<-readRDS(paste0(rds_output,"/var_RSO_Cd44posGzmbneg.rds"))

if (!('Seurat' %in% class(var_RSO_Cd44posGzmbneg))) { if (!(class(var_RSO_Cd44posGzmbneg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RSO_Cd44posGzmbneg <- as.data.frame(var_RSO_Cd44posGzmbneg)}}
#############################


# Processing input variable: var_RSN_Cd44posGzmbneg
var_RSN_Cd44posGzmbneg<-readRDS(paste0(rds_output,"/var_RSN_Cd44posGzmbneg.rds"))

if (!('Seurat' %in% class(var_RSN_Cd44posGzmbneg))) { if (!(class(var_RSN_Cd44posGzmbneg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RSN_Cd44posGzmbneg <- as.data.frame(var_RSN_Cd44posGzmbneg)}}
#############################


# Processing input variable: var_RMDT_Cd44posGzmbneg
var_RMDT_Cd44posGzmbneg<-readRDS(paste0(rds_output,"/var_RMDT_Cd44posGzmbneg.rds"))

if (!('Seurat' %in% class(var_RMDT_Cd44posGzmbneg))) { if (!(class(var_RMDT_Cd44posGzmbneg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RMDT_Cd44posGzmbneg <- as.data.frame(var_RMDT_Cd44posGzmbneg)}}
#############################

# Saving Output Dataset
invisible(graphics.off())
var_Cd44posGzmbneg_DEG<-Cd44posGzmbneg_DEG(var_RSO_Cd44posGzmbneg,var_RSN_Cd44posGzmbneg,var_RMDT_Cd44posGzmbneg)
saveRDS(var_Cd44posGzmbneg_DEG, paste0(rds_output,"/var_Cd44posGzmbneg_DEG.rds"))
