...
FMDT_TCF7pos_Tim3neg <- function(FSO_TCF7pos_Tim3neg) {
...
#image: png
    png(filename="FMDT_TCF7pos_Tim3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_FMDT_TCF7pos_Tim3neg.R #########################################################################")
...
var_FMDT_TCF7pos_Tim3neg<-FMDT_TCF7pos_Tim3neg(var_FSO_TCF7pos_Tim3neg)
saveRDS(var_FMDT_TCF7pos_Tim3neg, paste0(rds_output,"/var_FMDT_TCF7pos_Tim3neg.rds"))
