...
FMDT_Cd44posGzmbneg <- function(FSO_Cd44posGzmbneg) {
...
#image: png
    png(filename="FMDT_Cd44posGzmbneg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_FMDT_Cd44posGzmbneg.R #########################################################################")
...
var_FMDT_Cd44posGzmbneg<-FMDT_Cd44posGzmbneg(var_FSO_Cd44posGzmbneg)
saveRDS(var_FMDT_Cd44posGzmbneg, paste0(rds_output,"/var_FMDT_Cd44posGzmbneg.rds"))
