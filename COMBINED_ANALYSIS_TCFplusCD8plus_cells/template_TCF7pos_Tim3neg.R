...
TCF7pos_Tim3neg <- function(FSO_CD3CD8_Tcells,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
...
print("template_TCF7pos_Tim3neg.R #########################################################################")
...
var_TCF7pos_Tim3neg<-TCF7pos_Tim3neg(var_FSO_CD3CD8_Tcells,var_SampleNames_CellTypes)
saveRDS(var_TCF7pos_Tim3neg, paste0(rds_output,"/var_TCF7pos_Tim3neg.rds"))
