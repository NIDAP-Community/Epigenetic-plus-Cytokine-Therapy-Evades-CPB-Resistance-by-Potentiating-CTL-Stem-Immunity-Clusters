...
RMDT_TCF7pos_Tim3neg <- function(RSO_TCF7pos_Tim3neg) {
...
#image: png
    png(filename="RMDT_TCF7pos_Tim3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RMDT_TCF7pos_Tim3neg.R #########################################################################")
...
var_RMDT_TCF7pos_Tim3neg<-RMDT_TCF7pos_Tim3neg(var_RSO_TCF7pos_Tim3neg)
saveRDS(var_RMDT_TCF7pos_Tim3neg, paste0(rds_output,"/var_RMDT_TCF7pos_Tim3neg.rds"))
