...
DEGMarkers_1 <- function(Reclustered_CD3CD8_Tcells,RSN_CD3CD8_Tcells,RMDT_CD3CD8_Tcells) {
    ...
    seurat_object <- Reclustered_CD3CD8_Tcells
    metadata_table <- RMDT_CD3CD8_Tcells
...
# Processing input variable: var_Reclustered_CD3CD8_Tcells
var_Reclustered_CD3CD8_Tcells<-readRDS(paste0(rds_output,"/var_Reclustered_CD3CD8_Tcells.rds"))

if (!('Seurat' %in% class(var_Reclustered_CD3CD8_Tcells))) { if (!(class(var_Reclustered_CD3CD8_Tcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_Reclustered_CD3CD8_Tcells <- as.data.frame(var_Reclustered_CD3CD8_Tcells)}}
#############################


# Processing input variable: var_RSN_CD3CD8_Tcells
var_RSN_CD3CD8_Tcells<-readRDS(paste0(rds_output,"/var_RSN_CD3CD8_Tcells.rds"))

if (!('Seurat' %in% class(var_RSN_CD3CD8_Tcells))) { if (!(class(var_RSN_CD3CD8_Tcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RSN_CD3CD8_Tcells <- as.data.frame(var_RSN_CD3CD8_Tcells)}}
#############################


# Processing input variable: var_RMDT_CD3CD8_Tcells
var_RMDT_CD3CD8_Tcells<-readRDS(paste0(rds_output,"/var_RMDT_CD3CD8_Tcells.rds"))

if (!('Seurat' %in% class(var_RMDT_CD3CD8_Tcells))) { if (!(class(var_RMDT_CD3CD8_Tcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RMDT_CD3CD8_Tcells <- as.data.frame(var_RMDT_CD3CD8_Tcells)}}
#############################

# Saving Output Dataset
invisible(graphics.off())
var_DEGMarkers_1<-DEGMarkers_1(var_Reclustered_CD3CD8_Tcells,var_RSN_CD3CD8_Tcells,var_RMDT_CD3CD8_Tcells)
saveRDS(var_DEGMarkers_1, paste0(rds_output,"/var_DEGMarkers_1.rds"))
