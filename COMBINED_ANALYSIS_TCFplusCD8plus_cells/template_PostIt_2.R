...
#image: png
    png(filename="PostIt_2.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
var_PostIt_2<-PostIt_2()
saveRDS(var_PostIt_2, paste0(rds_output,"/var_PostIt_2.rds"))
