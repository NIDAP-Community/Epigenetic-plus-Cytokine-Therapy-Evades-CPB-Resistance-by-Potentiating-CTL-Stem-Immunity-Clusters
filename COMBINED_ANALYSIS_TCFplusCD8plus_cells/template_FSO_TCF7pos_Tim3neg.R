...
FSO_TCF7pos_Tim3neg <- function(TCF7pos_Tim3neg, MDT_TCF7pos_Tim3neg, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- TCF7pos_Tim3neg
    
    # Category parameters    
    category_to_filter <- "tcfpos_tim3neg"
    seed <- 10
...
print("template_FSO_TCF7pos_Tim3neg.R #########################################################################")
...
# Processing input variable: var_TCF7pos_Tim3neg
var_TCF7pos_Tim3neg<-readRDS(paste0(rds_output,"/var_TCF7pos_Tim3neg.rds"))

if (!('Seurat' %in% class(var_TCF7pos_Tim3neg))) { if (!(class(var_TCF7pos_Tim3neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_TCF7pos_Tim3neg <- as.data.frame(var_TCF7pos_Tim3neg)}}
#############################


# Processing input variable: var_MDT_TCF7pos_Tim3neg
var_MDT_TCF7pos_Tim3neg<-readRDS(paste0(rds_output,"/var_MDT_TCF7pos_Tim3neg.rds"))

if (!('Seurat' %in% class(var_MDT_TCF7pos_Tim3neg))) { if (!(class(var_MDT_TCF7pos_Tim3neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MDT_TCF7pos_Tim3neg <- as.data.frame(var_MDT_TCF7pos_Tim3neg)}}
#############################
...
var_FSO_TCF7pos_Tim3neg<-FSO_TCF7pos_Tim3neg(var_TCF7pos_Tim3neg,var_MDT_TCF7pos_Tim3neg,var_SampleNames_CellTypes)
saveRDS(var_FSO_TCF7pos_Tim3neg, paste0(rds_output,"/var_FSO_TCF7pos_Tim3neg.rds"))
