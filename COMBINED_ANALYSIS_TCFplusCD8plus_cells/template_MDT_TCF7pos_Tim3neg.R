...
MDT_TCF7pos_Tim3neg <- function(TCF7pos_Tim3neg) {
...
#image: png
    png(filename="MDT_TCF7pos_Tim3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MDT_TCF7pos_Tim3neg.R #########################################################################")
...
var_MDT_TCF7pos_Tim3neg<-MDT_TCF7pos_Tim3neg(var_TCF7pos_Tim3neg)
saveRDS(var_MDT_TCF7pos_Tim3neg, paste0(rds_output,"/var_MDT_TCF7pos_Tim3neg.rds"))
