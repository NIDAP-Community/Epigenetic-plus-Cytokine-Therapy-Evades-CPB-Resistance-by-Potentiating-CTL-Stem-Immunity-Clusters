...
#image: png
    png(filename="PostIt_CellTypes.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_CellTypes.R #########################################################################")
...
var_PostIt_CellTypes<-PostIt_CellTypes()
saveRDS(var_PostIt_CellTypes, paste0(rds_output,"/var_PostIt_CellTypes.rds"))
