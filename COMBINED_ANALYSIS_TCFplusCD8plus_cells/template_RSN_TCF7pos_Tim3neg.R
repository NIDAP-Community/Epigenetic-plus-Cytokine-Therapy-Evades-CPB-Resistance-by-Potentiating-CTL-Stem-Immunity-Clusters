...
RSN_TCF7pos_Tim3neg <- function(RSO_TCF7pos_Tim3neg) {
...
#image: png
    png(filename="RSN_TCF7pos_Tim3neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RSN_TCF7pos_Tim3neg.R #########################################################################")
...
var_RSN_TCF7pos_Tim3neg<-RSN_TCF7pos_Tim3neg(var_RSO_TCF7pos_Tim3neg)
saveRDS(var_RSN_TCF7pos_Tim3neg, paste0(rds_output,"/var_RSN_TCF7pos_Tim3neg.rds"))
