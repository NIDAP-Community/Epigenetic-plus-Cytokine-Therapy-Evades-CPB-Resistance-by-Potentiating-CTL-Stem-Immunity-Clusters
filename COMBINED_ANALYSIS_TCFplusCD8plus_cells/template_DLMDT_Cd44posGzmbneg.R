...
DLMDT_Cd44posGzmbneg <- function(DLSO_Cd44posGzmbneg) {
...
#image: png
    png(filename="DLMDT_Cd44posGzmbneg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_DLMDT_Cd44posGzmbneg.R #########################################################################")
...
var_DLMDT_Cd44posGzmbneg<-DLMDT_Cd44posGzmbneg(var_DLSO_Cd44posGzmbneg)
saveRDS(var_DLMDT_Cd44posGzmbneg, paste0(rds_output,"/var_DLMDT_Cd44posGzmbneg.rds"))
