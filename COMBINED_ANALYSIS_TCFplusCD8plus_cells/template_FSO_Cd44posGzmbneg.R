...
FSO_Cd44posGzmbneg <- function(DLSO_Cd44posGzmbneg, DLMDT_Cd44posGzmbneg, RSN_TCF7pos_Tim3neg) {
...
library(plotly)
    ...
    seurat_object <- DLSO_Cd44posGzmbneg
    
    # Category parameters    
    category_to_filter <- "Cd44posGzmbneg"
    seed <- 10
...
print("template_FSO_Cd44posGzmbneg.R #########################################################################")
...
# Processing input variable: var_DLSO_Cd44posGzmbneg
var_DLSO_Cd44posGzmbneg<-readRDS(paste0(rds_output,"/var_DLSO_Cd44posGzmbneg.rds"))

if (!('Seurat' %in% class(var_DLSO_Cd44posGzmbneg))) { if (!(class(var_DLSO_Cd44posGzmbneg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DLSO_Cd44posGzmbneg <- as.data.frame(var_DLSO_Cd44posGzmbneg)}}
#############################


# Processing input variable: var_DLMDT_Cd44posGzmbneg
var_DLMDT_Cd44posGzmbneg<-readRDS(paste0(rds_output,"/var_DLMDT_Cd44posGzmbneg.rds"))

if (!('Seurat' %in% class(var_DLMDT_Cd44posGzmbneg))) { if (!(class(var_DLMDT_Cd44posGzmbneg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DLMDT_Cd44posGzmbneg <- as.data.frame(var_DLMDT_Cd44posGzmbneg)}}
#############################
...
var_FSO_Cd44posGzmbneg<-FSO_Cd44posGzmbneg(var_DLSO_Cd44posGzmbneg,var_DLMDT_Cd44posGzmbneg,var_RSN_TCF7pos_Tim3neg)
saveRDS(var_FSO_Cd44posGzmbneg, paste0(rds_output,"/var_FSO_Cd44posGzmbneg.rds"))
