...
RMDT_CD3CD8_Tcells <- function(Reclustered_CD3CD8_Tcells) {
...
#image: png
    png(filename="RMDT_CD3CD8_Tcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RMDT_CD3CD8_Tcells.R #########################################################################")
...
var_RMDT_CD3CD8_Tcells<-RMDT_CD3CD8_Tcells(var_Reclustered_CD3CD8_Tcells)
saveRDS(var_RMDT_CD3CD8_Tcells, paste0(rds_output,"/var_RMDT_CD3CD8_Tcells.rds"))
