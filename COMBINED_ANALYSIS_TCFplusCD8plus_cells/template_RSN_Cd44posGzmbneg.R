...
RSN_Cd44posGzmbneg <- function(RSO_Cd44posGzmbneg) {
...
#image: png
    png(filename="RSN_Cd44posGzmbneg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RSN_Cd44posGzmbneg.R #########################################################################")
...
var_RSN_Cd44posGzmbneg<-RSN_Cd44posGzmbneg(var_RSO_Cd44posGzmbneg)
saveRDS(var_RSN_Cd44posGzmbneg, paste0(rds_output,"/var_RSN_Cd44posGzmbneg.rds"))
