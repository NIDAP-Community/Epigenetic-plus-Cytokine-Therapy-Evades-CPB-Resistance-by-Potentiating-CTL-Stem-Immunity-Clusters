...
FIGURE_3N_TripletvsPBS <- function(TCF7pos_Tim3neg_DEG) {
    # image: png
    ...
    no_genes_to_label <- 50
    use_only_addition_labels <- TRUE
    additional_labels <- "Bach2,Stat3,Ccr7,Satb1,Foxp1,Lef1,Kit,Fas,Ilr7,Stat4,Ccr2,Zeb1,Sell,Batf,Runx2"
    labSize <- 6    

    #Title and Axis labels Parameters
    change_sig_name <- "p-value"
    change_lfc_name <- "log2FC"
    title <- "T_ENT+N803+aPD1 vs. T_PBS"
    #subtitle <- ""
...
print("template_FIGURE_3N_TripletvsPBS.R #########################################################################")
...
var_FIGURE_3N_TripletvsPBS<-FIGURE_3N_TripletvsPBS(var_TCF7pos_Tim3neg_DEG)
saveRDS(var_FIGURE_3N_TripletvsPBS, paste0(rds_output,"/var_FIGURE_3N_TripletvsPBS.rds"))
