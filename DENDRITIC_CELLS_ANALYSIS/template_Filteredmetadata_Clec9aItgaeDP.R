...
Filteredmetadata_Clec9aItgaeDP <- function(FilteredSO_Clec9aItgaeDP) {
...
#image: png
    png(filename="Filteredmetadata_Clec9aItgaeDP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_Filteredmetadata_Clec9aItgaeDP.R #########################################################################")
...
var_Filteredmetadata_Clec9aItgaeDP<-Filteredmetadata_Clec9aItgaeDP(var_FilteredSO_Clec9aItgaeDP)
saveRDS(var_Filteredmetadata_Clec9aItgaeDP, paste0(rds_output,"/var_Filteredmetadata_Clec9aItgaeDP.rds"))
