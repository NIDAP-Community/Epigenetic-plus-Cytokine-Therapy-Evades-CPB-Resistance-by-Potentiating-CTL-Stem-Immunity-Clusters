...
#image: png
    png(filename="PostIt_QCFiltered.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_PostIt_QCFiltered.R #########################################################################")
...
var_PostIt_QCFiltered<-PostIt_QCFiltered()
saveRDS(var_PostIt_QCFiltered, paste0(rds_output,"/var_PostIt_QCFiltered.rds"))
