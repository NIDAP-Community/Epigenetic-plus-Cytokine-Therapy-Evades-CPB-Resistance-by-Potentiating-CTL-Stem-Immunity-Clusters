...
Filtered_SO_DualLabel_CD11cNcr1 <- function(DualLabelSO_CD11cNcr1, MetadataTable_DualLabelCD11cNcr1, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- DualLabelSO_CD11cNcr1
    
    # Category parameters    
    category_to_filter <- "Itgaxpos_ncr1neg"
    seed <- 10
...
print("template_Filtered_SO_DualLabel_CD11cNcr1.R #########################################################################")
...
# Processing input variable: var_DualLabelSO_CD11cNcr1
var_DualLabelSO_CD11cNcr1<-readRDS(paste0(rds_output,"/var_DualLabelSO_CD11cNcr1.rds"))

if (!('Seurat' %in% class(var_DualLabelSO_CD11cNcr1))) { if (!(class(var_DualLabelSO_CD11cNcr1) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DualLabelSO_CD11cNcr1 <- as.data.frame(var_DualLabelSO_CD11cNcr1)}}
#############################


# Processing input variable: var_MetadataTable_DualLabelCD11cNcr1
var_MetadataTable_DualLabelCD11cNcr1<-readRDS(paste0(rds_output,"/var_MetadataTable_DualLabelCD11cNcr1.rds"))

if (!('Seurat' %in% class(var_MetadataTable_DualLabelCD11cNcr1))) { if (!(class(var_MetadataTable_DualLabelCD11cNcr1) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MetadataTable_DualLabelCD11cNcr1 <- as.data.frame(var_MetadataTable_DualLabelCD11cNcr1)}}
#############################
...
var_Filtered_SO_DualLabel_CD11cNcr1<-Filtered_SO_DualLabel_CD11cNcr1(var_DualLabelSO_CD11cNcr1,var_MetadataTable_DualLabelCD11cNcr1,var_SampleNames_CellTypes)
saveRDS(var_Filtered_SO_DualLabel_CD11cNcr1, paste0(rds_output,"/var_Filtered_SO_DualLabel_CD11cNcr1.rds"))
