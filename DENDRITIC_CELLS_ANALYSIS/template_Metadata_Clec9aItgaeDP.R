...
Metadata_Clec9aItgaeDP <- function(Clec9aItgaeDP) {
...
#image: png
    png(filename="Metadata_Clec9aItgaeDP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_Metadata_Clec9aItgaeDP.R #########################################################################")
...
var_Metadata_Clec9aItgaeDP<-Metadata_Clec9aItgaeDP(var_Clec9aItgaeDP)
saveRDS(var_Metadata_Clec9aItgaeDP, paste0(rds_output,"/var_Metadata_Clec9aItgaeDP.rds"))
