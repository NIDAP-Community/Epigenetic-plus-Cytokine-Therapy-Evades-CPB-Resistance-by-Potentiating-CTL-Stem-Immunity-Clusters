...
MetadataTable_CellTypes <- function(CellTypesSO) {
...
#image: png
    png(filename="MetadataTable_CellTypes.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_CellTypes.R #########################################################################")
...
var_MetadataTable_CellTypes<-MetadataTable_CellTypes(var_CellTypesSO)
saveRDS(var_MetadataTable_CellTypes, paste0(rds_output,"/var_MetadataTable_CellTypes.rds"))
