...
Metadata_Table_DualLabel_CD11cNcr1 <- function(Filtered_SO_DualLabel_CD11cNcr1) {
...
#image: png
    png(filename="Metadata_Table_DualLabel_CD11cNcr1.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_Metadata_Table_DualLabel_CD11cNcr1.R #########################################################################")
...
var_Metadata_Table_DualLabel_CD11cNcr1<-Metadata_Table_DualLabel_CD11cNcr1(var_Filtered_SO_DualLabel_CD11cNcr1)
saveRDS(var_Metadata_Table_DualLabel_CD11cNcr1, paste0(rds_output,"/var_Metadata_Table_DualLabel_CD11cNcr1.rds"))
