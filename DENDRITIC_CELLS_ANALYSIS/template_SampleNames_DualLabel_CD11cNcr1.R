...
SampleNames_DualLabel_CD11cNcr1 <- function(ReclusterSO_DualLabel_CD11cNcr1) {
...
#image: png
    png(filename="SampleNames_DualLabel_CD11cNcr1.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_SampleNames_DualLabel_CD11cNcr1.R #########################################################################")
...
var_SampleNames_DualLabel_CD11cNcr1<-SampleNames_DualLabel_CD11cNcr1(var_ReclusterSO_DualLabel_CD11cNcr1)
saveRDS(var_SampleNames_DualLabel_CD11cNcr1, paste0(rds_output,"/var_SampleNames_DualLabel_CD11cNcr1.rds"))
