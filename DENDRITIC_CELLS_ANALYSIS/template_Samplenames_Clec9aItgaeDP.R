...
Samplenames_Clec9aItgaeDP <- function(ReclusterSO_Clec9aItgaeDP) {
...
#image: png
    png(filename="Samplenames_Clec9aItgaeDP.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_Samplenames_Clec9aItgaeDP.R #########################################################################")
...
var_Samplenames_Clec9aItgaeDP<-Samplenames_Clec9aItgaeDP(var_ReclusterSO_Clec9aItgaeDP)
saveRDS(var_Samplenames_Clec9aItgaeDP, paste0(rds_output,"/var_Samplenames_Clec9aItgaeDP.rds"))
