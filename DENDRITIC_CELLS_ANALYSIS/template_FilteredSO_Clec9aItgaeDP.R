...
FilteredSO_Clec9aItgaeDP <- function(Clec9aItgaeDP, Metadata_Clec9aItgaeDP, SampleNames_DualLabel_CD11cNcr1) {
...
library(plotly)
    ...
    cut_off <- 0.5
    category_to_filter <- "Clec9aItgaeDP"
...
print("template_FilteredSO_Clec9aItgaeDP.R #########################################################################")
...
# Processing input variable: var_Clec9aItgaeDP
var_Clec9aItgaeDP<-readRDS(paste0(rds_output,"/var_Clec9aItgaeDP.rds"))

if (!('Seurat' %in% class(var_Clec9aItgaeDP))) { if (!(class(var_Clec9aItgaeDP) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_Clec9aItgaeDP <- as.data.frame(var_Clec9aItgaeDP)}}
#############################


# Processing input variable: var_Metadata_Clec9aItgaeDP
var_Metadata_Clec9aItgaeDP<-readRDS(paste0(rds_output,"/var_Metadata_Clec9aItgaeDP.rds"))

if (!('Seurat' %in% class(var_Metadata_Clec9aItgaeDP))) { if (!(class(var_Metadata_Clec9aItgaeDP) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_Metadata_Clec9aItgaeDP <- as.data.frame(var_Metadata_Clec9aItgaeDP)}}
#############################
...
var_FilteredSO_Clec9aItgaeDP<-FilteredSO_Clec9aItgaeDP(var_Clec9aItgaeDP,var_Metadata_Clec9aItgaeDP,var_SampleNames_DualLabel_CD11cNcr1)
saveRDS(var_FilteredSO_Clec9aItgaeDP, paste0(rds_output,"/var_FilteredSO_Clec9aItgaeDP.rds"))
