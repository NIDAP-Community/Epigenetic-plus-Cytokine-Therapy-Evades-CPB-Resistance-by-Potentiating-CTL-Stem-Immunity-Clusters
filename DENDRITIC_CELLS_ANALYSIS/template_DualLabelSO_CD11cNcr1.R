...
DualLabelSO_CD11cNcr1 <- function(CellTypesSO,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
    ...
    #Filter Parameters:
    filter_data <- TRUE
    parameter_name <- "Itgaxpos_ncr1neg"
...
print("template_DualLabelSO_CD11cNcr1.R #########################################################################")
...
var_DualLabelSO_CD11cNcr1<-DualLabelSO_CD11cNcr1(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_DualLabelSO_CD11cNcr1, paste0(rds_output,"/var_DualLabelSO_CD11cNcr1.rds"))
