...
GSEA_Preranked <- function(FIGURE_5D_ENTN803aPD1_vs_PBS, msigdb_v6_2_with_orthologs) {
...
# Primary inputs
deg_table = FIGURE_5D_ENTN803aPD1_vs_PBS
pathways_database = msigdb_v6_2_with_orthologs

# Basic parameters
gene_names_column = "Gene"
species = "Mouse"
collections_to_include = c("C5: GO gene sets","H: hallmark gene sets","CP:KEGG: KEGG gene sets")
...
print("template_GSEA_Preranked.R #########################################################################")
...
var_GSEA_Preranked<-GSEA_Preranked(var_FIGURE_5D_ENTN803aPD1_vs_PBS,var_msigdb_v6_2_with_orthologs)
