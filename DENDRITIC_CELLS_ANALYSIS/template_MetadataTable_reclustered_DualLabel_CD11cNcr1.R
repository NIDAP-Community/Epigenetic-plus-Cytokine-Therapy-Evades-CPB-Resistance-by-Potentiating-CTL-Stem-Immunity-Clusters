...
MetadataTable_reclustered_DualLabel_CD11cNcr1 <- function(ReclusterSO_DualLabel_CD11cNcr1) {
...
#image: png
    png(filename="MetadataTable_reclustered_DualLabel_CD11cNcr1.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_reclustered_DualLabel_CD11cNcr1.R #########################################################################")
...
var_MetadataTable_reclustered_DualLabel_CD11cNcr1<-MetadataTable_reclustered_DualLabel_CD11cNcr1(var_ReclusterSO_DualLabel_CD11cNcr1)
saveRDS(var_MetadataTable_reclustered_DualLabel_CD11cNcr1, paste0(rds_output,"/var_MetadataTable_reclustered_DualLabel_CD11cNcr1.rds"))
