...
FIGURE_5Bpart1 <- function(FIGURE_5D_ENTN803aPD1_vs_PBS, GSEA_Filtered, DEGmarkers_Clec9aItgaeDP, Reclusteredmetadata_Clec9aItgaeDP, msigdb_v6_2_with_orthologs) {
...
png(filename="FIGURE_5Bpart1.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_FIGURE_5Bpart1.R #########################################################################")
...
var_FIGURE_5Bpart1<-FIGURE_5Bpart1(var_FIGURE_5D_ENTN803aPD1_vs_PBS,var_GSEA_Filtered,var_DEGmarkers_Clec9aItgaeDP,var_Reclusteredmetadata_Clec9aItgaeDP,var_msigdb_v6_2_with_orthologs)
saveRDS(var_FIGURE_5Bpart1, paste0(rds_output,"/var_FIGURE_5Bpart1.rds"))
