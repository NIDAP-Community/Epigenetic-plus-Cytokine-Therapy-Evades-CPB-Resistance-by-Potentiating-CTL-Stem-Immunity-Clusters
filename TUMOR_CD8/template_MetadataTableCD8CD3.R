...
MetadataTableCD8CD3 <- function(DualLabelSO_CD8CD3) {
...
#image: png
    png(filename="MetadataTableCD8CD3.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTableCD8CD3.R #########################################################################")
...
var_MetadataTableCD8CD3<-MetadataTableCD8CD3(var_DualLabelSO_CD8CD3)
saveRDS(var_MetadataTableCD8CD3, paste0(rds_output,"/var_MetadataTableCD8CD3.rds"))
