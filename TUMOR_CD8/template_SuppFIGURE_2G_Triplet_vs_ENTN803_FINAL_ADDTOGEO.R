...
SuppFIGURE_2G_Triplet_vs_ENTN803_FINAL_ADDTOGEO <- function(DEGMarkers_Reclustered_CD8CD3) {
    ...
    pathways_to_use_up <- c("HALLMARK_TNFA_SIGNALING_VIA_NFKB","HALLMARK_INFLAMMATORY_RESPONSE","immune response","HALLMARK_APOPTOSIS","regulation of leukocyte activation","regulation of cell death","negative regulation of programmed cell death","negative regulation of apoptotic process","immune system process","immune system process")
...
print("template_SuppFIGURE_2G_Triplet_vs_ENTN803_FINAL_ADDTOGEO.R #########################################################################")
...
var_SuppFIGURE_2G_Triplet_vs_ENTN803_FINAL_ADDTOGEO<-SuppFIGURE_2G_Triplet_vs_ENTN803_FINAL_ADDTOGEO(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_2G_Triplet_vs_ENTN803_FINAL_ADDTOGEO, paste0(rds_output,"/var_SuppFIGURE_2G_Triplet_vs_ENTN803_FINAL_ADDTOGEO.rds"))
