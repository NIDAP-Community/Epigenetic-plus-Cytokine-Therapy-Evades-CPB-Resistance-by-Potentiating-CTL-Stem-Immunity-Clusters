...
SuppFIGURE_3C_ENTvsPBS <- function(DEGMarkers_CD8_GzmbposKi67neg) {
    # image: png
...
print("template_SuppFIGURE_3C_ENTvsPBS.R #########################################################################")
...
var_SuppFIGURE_3C_ENTvsPBS<-SuppFIGURE_3C_ENTvsPBS(var_DEGMarkers_CD8_GzmbposKi67neg)
saveRDS(var_SuppFIGURE_3C_ENTvsPBS, paste0(rds_output,"/var_SuppFIGURE_3C_ENTvsPBS.rds"))
