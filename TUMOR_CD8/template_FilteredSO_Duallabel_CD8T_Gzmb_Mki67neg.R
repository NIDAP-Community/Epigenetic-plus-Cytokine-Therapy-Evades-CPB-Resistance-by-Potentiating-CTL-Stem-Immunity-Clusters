...
FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg <- function(DualLabelSO_CD8T_Gzmb_Mki67neg_copied, MetadataTable_CD8T_Gzmb_Mki67neg_copied, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- DualLabelSO_CD8T_Gzmb_Mki67neg_copied
    
    # Category parameters    
    category_to_filter <- "CD8T_Gzmb_Mki67neg"
    seed <- 10
    ...
    dot_size <- 0.5
    dot_size_highlighted_cells <- 1
    colors <- c("steelblue","palevioletred1")
...
print("template_FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg.R #########################################################################")
...
# Processing input variable: var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied
var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied<-readRDS(paste0(rds_output,"/var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied.rds"))

if (!('Seurat' %in% class(var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied))) { if (!(class(var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied <- as.data.frame(var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied)}}
#############################


# Processing input variable: var_MetadataTable_CD8T_Gzmb_Mki67neg_copied
var_MetadataTable_CD8T_Gzmb_Mki67neg_copied<-readRDS(paste0(rds_output,"/var_MetadataTable_CD8T_Gzmb_Mki67neg_copied.rds"))

if (!('Seurat' %in% class(var_MetadataTable_CD8T_Gzmb_Mki67neg_copied))) { if (!(class(var_MetadataTable_CD8T_Gzmb_Mki67neg_copied) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MetadataTable_CD8T_Gzmb_Mki67neg_copied <- as.data.frame(var_MetadataTable_CD8T_Gzmb_Mki67neg_copied)}}
#############################
...
var_FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg<-FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg(var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied,var_MetadataTable_CD8T_Gzmb_Mki67neg_copied,var_SampleNames_CellTypes)
saveRDS(var_FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg, paste0(rds_output,"/var_FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg.rds"))
