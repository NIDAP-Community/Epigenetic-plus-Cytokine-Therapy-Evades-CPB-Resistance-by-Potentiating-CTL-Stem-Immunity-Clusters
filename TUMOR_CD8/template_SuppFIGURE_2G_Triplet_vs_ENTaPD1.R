# L2P Analysis for Single Comparisons [CCBR] [scRNA-seq] [Bulk] (ff44bcce-10c1-4147-a089-79cadc4ea68a): v144
SuppFIGURE_2G_Triplet_vs_ENTaPD1 <- function(DEGMarkers_Reclustered_CD8CD3) {
    ...
    significance_column <- c("C_ENT+N803+aPD1_vs_ENT+aPD1_pval")[1]
    significance_threshold <- 0.05
    fold_change_column <- c("C_ENT+N803+aPD1_vs_ENT+aPD1_logFC")[1]
    fold_change_threshold <- 1.2
    minimum_number_of_DEG_genes <- 47
    ...
    for(i in 1:length(x)){ 
        x[[i]] %>% dplyr::mutate(pathwayname2 = stringr::str_replace_all(pathway_name, "_", " ")) -> goResults
...
print("template_SuppFIGURE_2G_Triplet_vs_ENTaPD1.R #########################################################################")
...
var_SuppFIGURE_2G_Triplet_vs_ENTaPD1<-SuppFIGURE_2G_Triplet_vs_ENTaPD1(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_2G_Triplet_vs_ENTaPD1, paste0(rds_output,"/var_SuppFIGURE_2G_Triplet_vs_ENTaPD1.rds"))
