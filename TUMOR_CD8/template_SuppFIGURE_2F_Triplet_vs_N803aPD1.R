...
SuppFIGURE_2F_Triplet_vs_N803aPD1 <- function(DEGMarkers_Reclustered_CD8CD3) {
    # image: png
    ...
    additional_labels <- "Gzmf,Gzmc,Gzmd,Gzme,Gzmb,Irf8,Ctla4,Il1b,Cd3d,Icos,Il7r,Stat3,Il2ra,Pdcd1"
    labSize <- 12    

    #Title and Axis labels Parameters
    change_sig_name <- "p-value"
    change_lfc_name <- "log2FC"
    title <- "ENTN803aPD1vsN803aPD1"
    #subtitle <- ""
...
print("template_SuppFIGURE_2F_Triplet_vs_N803aPD1.R #########################################################################")
...
var_SuppFIGURE_2F_Triplet_vs_N803aPD1<-SuppFIGURE_2F_Triplet_vs_N803aPD1(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_2F_Triplet_vs_N803aPD1, paste0(rds_output,"/var_SuppFIGURE_2F_Triplet_vs_N803aPD1.rds"))
