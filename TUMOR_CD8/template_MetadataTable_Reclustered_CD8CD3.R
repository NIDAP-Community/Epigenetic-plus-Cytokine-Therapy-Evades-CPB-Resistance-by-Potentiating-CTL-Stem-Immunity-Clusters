...
MetadataTable_Reclustered_CD8CD3 <- function(ReclusterSO_CD8cd3) {
...
#image: png
    png(filename="MetadataTable_Reclustered_CD8CD3.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_Reclustered_CD8CD3.R #########################################################################")
...
var_MetadataTable_Reclustered_CD8CD3<-MetadataTable_Reclustered_CD8CD3(var_ReclusterSO_CD8cd3)
saveRDS(var_MetadataTable_Reclustered_CD8CD3, paste0(rds_output,"/var_MetadataTable_Reclustered_CD8CD3.rds"))
