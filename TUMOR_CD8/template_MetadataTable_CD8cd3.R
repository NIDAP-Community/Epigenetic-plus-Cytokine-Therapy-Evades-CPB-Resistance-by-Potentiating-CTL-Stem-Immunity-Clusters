...
MetadataTable_CD8cd3 <- function(FilteredSO_CD8CD3) {
...
#image: png
    png(filename="MetadataTable_CD8cd3.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_CD8cd3.R #########################################################################")
...
var_MetadataTable_CD8cd3<-MetadataTable_CD8cd3(var_FilteredSO_CD8CD3)
saveRDS(var_MetadataTable_CD8cd3, paste0(rds_output,"/var_MetadataTable_CD8cd3.rds"))
