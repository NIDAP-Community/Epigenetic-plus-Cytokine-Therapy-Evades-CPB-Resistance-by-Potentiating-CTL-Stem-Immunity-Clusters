...
SuppFIGURE_3A_ENT <- function(ReclusterSO_CD8cd3,SampleNames_Reclustered_CD8CD3) {
...
print("template_SuppFIGURE_3A_ENT.R #########################################################################")
...
var_SuppFIGURE_3A_ENT<-SuppFIGURE_3A_ENT(var_ReclusterSO_CD8cd3,var_SampleNames_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_3A_ENT, paste0(rds_output,"/var_SuppFIGURE_3A_ENT.rds"))
