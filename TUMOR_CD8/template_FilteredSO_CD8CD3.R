...
FilteredSO_CD8CD3 <- function(DualLabelSO_CD8CD3, MetadataTableCD8CD3, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- DualLabelSO_CD8CD3
...
print("template_FilteredSO_CD8CD3.R #########################################################################")
...
# Processing input variable: var_DualLabelSO_CD8CD3
var_DualLabelSO_CD8CD3<-readRDS(paste0(rds_output,"/var_DualLabelSO_CD8CD3.rds"))

if (!('Seurat' %in% class(var_DualLabelSO_CD8CD3))) { if (!(class(var_DualLabelSO_CD8CD3) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DualLabelSO_CD8CD3 <- as.data.frame(var_DualLabelSO_CD8CD3)}}
#############################


# Processing input variable: var_MetadataTableCD8CD3
var_MetadataTableCD8CD3<-readRDS(paste0(rds_output,"/var_MetadataTableCD8CD3.rds"))

if (!('Seurat' %in% class(var_MetadataTableCD8CD3))) { if (!(class(var_MetadataTableCD8CD3) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MetadataTableCD8CD3 <- as.data.frame(var_MetadataTableCD8CD3)}}
#############################
...
var_FilteredSO_CD8CD3<-FilteredSO_CD8CD3(var_DualLabelSO_CD8CD3,var_MetadataTableCD8CD3,var_SampleNames_CellTypes)
saveRDS(var_FilteredSO_CD8CD3, paste0(rds_output,"/var_FilteredSO_CD8CD3.rds"))
