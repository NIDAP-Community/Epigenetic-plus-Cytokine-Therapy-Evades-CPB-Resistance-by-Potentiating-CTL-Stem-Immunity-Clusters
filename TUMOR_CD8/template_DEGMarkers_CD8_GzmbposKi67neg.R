...
DEGMarkers_CD8_GzmbposKi67neg <- function(ReclusterSO_CD8_GzmbposKi67neg,SampleNames_CD8_GzmbposKi67neg,MetadataTable_CD8GzmbposKi67neg) {
    ...
    seurat_object <- ReclusterSO_CD8_GzmbposKi67neg
    metadata_table <- MetadataTable_CD8GzmbposKi67neg
...
# Contrasts parameters
    ...
    contrasts <- c("ENT-PBS","N803-PBS","aPD1-PBS","ENT+aPD1-PBS","ENT+N803-PBS","N803+aPD1-PBS","ENT+N803+aPD1-PBS","ENT+N803+aPD1-ENT+aPD1","ENT+N803+aPD1-ENT+N803","ENT+N803+aPD1-N803+aPD1","ENT+aPD1-ENT","ENT+aPD1-aPD1","ENT+N803-ENT","ENT+N803-N803")
...
print("template_DEGMarkers_CD8_GzmbposKi67neg.R #########################################################################")
...
# Processing input variable: var_ReclusterSO_CD8_GzmbposKi67neg
var_ReclusterSO_CD8_GzmbposKi67neg<-readRDS(paste0(rds_output,"/var_ReclusterSO_CD8_GzmbposKi67neg.rds"))

if (!('Seurat' %in% class(var_ReclusterSO_CD8_GzmbposKi67neg))) { if (!(class(var_ReclusterSO_CD8_GzmbposKi67neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ReclusterSO_CD8_GzmbposKi67neg <- as.data.frame(var_ReclusterSO_CD8_GzmbposKi67neg)}}
#############################


# Processing input variable: var_SampleNames_CD8_GzmbposKi67neg
var_SampleNames_CD8_GzmbposKi67neg<-readRDS(paste0(rds_output,"/var_SampleNames_CD8_GzmbposKi67neg.rds"))

if (!('Seurat' %in% class(var_SampleNames_CD8_GzmbposKi67neg))) { if (!(class(var_SampleNames_CD8_GzmbposKi67neg) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_SampleNames_CD8_GzmbposKi67neg <- as.data.frame(var_SampleNames_CD8_GzmbposKi67neg)}}
#############################
...
var_DEGMarkers_CD8_GzmbposKi67neg<-DEGMarkers_CD8_GzmbposKi67neg(var_ReclusterSO_CD8_GzmbposKi67neg,var_SampleNames_CD8_GzmbposKi67neg,var_MetadataTable_CD8GzmbposKi67neg)
saveRDS(var_DEGMarkers_CD8_GzmbposKi67neg, paste0(rds_output,"/var_DEGMarkers_CD8_GzmbposKi67neg.rds"))
