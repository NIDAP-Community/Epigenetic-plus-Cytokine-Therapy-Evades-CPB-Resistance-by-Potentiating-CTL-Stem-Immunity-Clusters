...
SuppFIGURE_2F_ENT_vs_PBS <- function(DEGMarkers_Reclustered_CD8CD3) {
    # image: png
    ...
    label.col <- "Gene"
    sig.col <- c("C_ENT_vs_PBS_pval")
    pCutoff  = 0.05
    lfc.col <- c("C_ENT_vs_PBS_logFC")
    FCcutoff = 0.26303
    ...
    additional_labels <- "Gzmf,Gzmc,Ccl4,Ccl3,Gzmd,Ccl5,Gzmb,Gzme,Irf8,Mki67,Prf1,Havcr2, Il2rb,Ccr5,Ly6e,Mdm4,Runx3,Cd3d,Entpd1,Cxcr6"
    labSize <- 12    
...
print("template_SuppFIGURE_2F_ENT_vs_PBS.R #########################################################################")
...
var_SuppFIGURE_2F_ENT_vs_PBS<-SuppFIGURE_2F_ENT_vs_PBS(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_2F_ENT_vs_PBS, paste0(rds_output,"/var_SuppFIGURE_2F_ENT_vs_PBS.rds"))
