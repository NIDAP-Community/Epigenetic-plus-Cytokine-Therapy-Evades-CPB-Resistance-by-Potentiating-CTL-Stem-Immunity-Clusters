...
SampleNames_Reclustered <- function(ReclusteredSO_CD8Tcells) {
...
#image: png
    png(filename="SampleNames_Reclustered.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_SampleNames_Reclustered.R #########################################################################")
...
var_SampleNames_Reclustered<-SampleNames_Reclustered(var_ReclusteredSO_CD8Tcells)
saveRDS(var_SampleNames_Reclustered, paste0(rds_output,"/var_SampleNames_Reclustered.rds"))
