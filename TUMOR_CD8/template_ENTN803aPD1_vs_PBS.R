...
ENTN803aPD1_vs_PBS <- function(DEGMarkers_CD8_GzmbposKi67neg) {
    # image: png
    ...
    additional_labels <- "Gzmf,Gzmd,Gzmc,Gzme,Ifitm1,Ccl5,Gzmb,Mt1,Ifitm2,Zc3h7a,Gm42418,Lars2,Bcl2,Dusp1,Zfp36l2,Def8,Inpp4b,Txnip"
    labSize <- 11    

    #Title and Axis labels Parameters
    change_sig_name <- "p-value"
    change_lfc_name <- "log2FC"
    title <- "ENTN803aPD1vsPBS"
    #subtitle <- ""
...
print("template_ENTN803aPD1_vs_PBS.R #########################################################################")
...
var_ENTN803aPD1_vs_PBS<-ENTN803aPD1_vs_PBS(var_DEGMarkers_CD8_GzmbposKi67neg)
saveRDS(var_ENTN803aPD1_vs_PBS, paste0(rds_output,"/var_ENTN803aPD1_vs_PBS.rds"))
