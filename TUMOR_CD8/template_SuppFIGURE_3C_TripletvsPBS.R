...
SuppFIGURE_3C_TripletvsPBS <- function(DEGMarkers_CD8_GzmbposKi67neg) {
    # image: png
...
print("template_SuppFIGURE_3C_TripletvsPBS.R #########################################################################")
...
var_SuppFIGURE_3C_TripletvsPBS<-SuppFIGURE_3C_TripletvsPBS(var_DEGMarkers_CD8_GzmbposKi67neg)
saveRDS(var_SuppFIGURE_3C_TripletvsPBS, paste0(rds_output,"/var_SuppFIGURE_3C_TripletvsPBS.rds"))
