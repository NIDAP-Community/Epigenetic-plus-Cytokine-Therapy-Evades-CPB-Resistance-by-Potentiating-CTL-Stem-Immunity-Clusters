...
DualLabelSO_CD8T_Gzmb_Mki67neg_copied <- function(ReclusterSO_CD8cd3,SampleNames_Reclustered_CD8CD3) {  # produces 2 color channels and the overlay
    ...
    marker1 <- "Gzmb"
    marker_1_threshold <- 0.023
    marker_1_type <- "SCT"
    marker2 <- "Mki67"
    marker_2_threshold <- 0.021
    marker_2_type <- "SCT"
    
    #Filter Parameters:
    filter_data <- TRUE
    parameter_name <- "CD8T_Gzmb_Mki67neg"
    marker.1.filter.direction <- "greater than"
    marker.2.filter.direction <- "less than"
    apply_filter_1 <- TRUE
    apply_filter_2 <- TRUE
...
print("template_DualLabelSO_CD8T_Gzmb_Mki67neg_copied.R #########################################################################")
...
var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied<-DualLabelSO_CD8T_Gzmb_Mki67neg_copied(var_ReclusterSO_CD8cd3,var_SampleNames_Reclustered_CD8CD3)
saveRDS(var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied, paste0(rds_output,"/var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied.rds"))
