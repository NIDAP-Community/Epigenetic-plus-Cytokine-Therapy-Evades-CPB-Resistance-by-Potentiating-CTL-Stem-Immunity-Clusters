...
SuppFIGURE_3C_aPD1vsPBS <- function(DEGMarkers_CD8_GzmbposKi67neg) {
    # image: png
...
print("template_SuppFIGURE_3C_aPD1vsPBS.R #########################################################################")
...
var_SuppFIGURE_3C_aPD1vsPBS<-SuppFIGURE_3C_aPD1vsPBS(var_DEGMarkers_CD8_GzmbposKi67neg)
saveRDS(var_SuppFIGURE_3C_aPD1vsPBS, paste0(rds_output,"/var_SuppFIGURE_3C_aPD1vsPBS.rds"))
