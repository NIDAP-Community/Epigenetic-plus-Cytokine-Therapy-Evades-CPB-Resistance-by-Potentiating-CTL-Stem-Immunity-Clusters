...
SuppFIGURE_2F_Triplet_vs_ENTaPD1 <- function(DEGMarkers_Reclustered_CD8CD3) {
    # image: png
...
print("template_SuppFIGURE_2F_Triplet_vs_ENTaPD1.R #########################################################################")
...
var_SuppFIGURE_2F_Triplet_vs_ENTaPD1<-SuppFIGURE_2F_Triplet_vs_ENTaPD1(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_2F_Triplet_vs_ENTaPD1, paste0(rds_output,"/var_SuppFIGURE_2F_Triplet_vs_ENTaPD1.rds"))
