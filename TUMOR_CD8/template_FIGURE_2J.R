...
FIGURE_2J <- function(DEGMarkers_Reclustered_CD8CD3) {
    ...
    minimum_number_of_DEG_genes <- 64
    
    #Visual Parameters:
    number_of_pathways_to_plot <- 25 
...
var_FIGURE_2J<-FIGURE_2J(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_FIGURE_2J, paste0(rds_output,"/var_FIGURE_2J.rds"))
