...
SuppFIGURE_3A_ENTN803aPD1 <- function(ReclusterSO_CD8cd3,SampleNames_Reclustered_CD8CD3) {
    ...
    # Basic Parameters:
    samples_to_include <- 'c("ENT+N803+aPD1")'
    gene <- c("Gzmb","Mki67","Gzmc","Gzmf","Gzmd","Gzme","Ifng","Cd8a")
...
print("template_SuppFIGURE_3A_ENTN803aPD1.R #########################################################################")
...
var_SuppFIGURE_3A_ENTN803aPD1<-SuppFIGURE_3A_ENTN803aPD1(var_ReclusterSO_CD8cd3,var_SampleNames_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_3A_ENTN803aPD1, paste0(rds_output,"/var_SuppFIGURE_3A_ENTN803aPD1.rds"))
