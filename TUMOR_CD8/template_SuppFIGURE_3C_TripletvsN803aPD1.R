...
SuppFIGURE_3C_TripletvsN803aPD1 <- function(DEGMarkers_CD8_GzmbposKi67neg) {
    # image: png
...
print("template_SuppFIGURE_3C_TripletvsN803aPD1.R #########################################################################")
...
var_SuppFIGURE_3C_TripletvsN803aPD1<-SuppFIGURE_3C_TripletvsN803aPD1(var_DEGMarkers_CD8_GzmbposKi67neg)
saveRDS(var_SuppFIGURE_3C_TripletvsN803aPD1, paste0(rds_output,"/var_SuppFIGURE_3C_TripletvsN803aPD1.rds"))
