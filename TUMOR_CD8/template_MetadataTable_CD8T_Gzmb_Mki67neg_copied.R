...
MetadataTable_CD8T_Gzmb_Mki67neg_copied <- function(DualLabelSO_CD8T_Gzmb_Mki67neg_copied) {
...
#image: png
    png(filename="MetadataTable_CD8T_Gzmb_Mki67neg_copied.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_CD8T_Gzmb_Mki67neg_copied.R #########################################################################")
...
var_MetadataTable_CD8T_Gzmb_Mki67neg_copied<-MetadataTable_CD8T_Gzmb_Mki67neg_copied(var_DualLabelSO_CD8T_Gzmb_Mki67neg_copied)
saveRDS(var_MetadataTable_CD8T_Gzmb_Mki67neg_copied, paste0(rds_output,"/var_MetadataTable_CD8T_Gzmb_Mki67neg_copied.rds"))
