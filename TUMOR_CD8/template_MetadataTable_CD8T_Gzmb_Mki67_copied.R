...
MetadataTable_CD8T_Gzmb_Mki67_copied <- function(FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg) {
...
#image: png
    png(filename="MetadataTable_CD8T_Gzmb_Mki67_copied.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_CD8T_Gzmb_Mki67_copied.R #########################################################################")
...
var_MetadataTable_CD8T_Gzmb_Mki67_copied<-MetadataTable_CD8T_Gzmb_Mki67_copied(var_FilteredSO_Duallabel_CD8T_Gzmb_Mki67neg)
saveRDS(var_MetadataTable_CD8T_Gzmb_Mki67_copied, paste0(rds_output,"/var_MetadataTable_CD8T_Gzmb_Mki67_copied.rds"))
