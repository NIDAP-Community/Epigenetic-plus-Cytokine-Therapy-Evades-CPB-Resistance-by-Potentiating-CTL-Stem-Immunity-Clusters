...
GSEA_Preranked <- function(ENTN803aPD1_vs_PBS, msigdb_v6_2_with_orthologs) {
...
# Primary inputs
deg_table = ENTN803aPD1_vs_PBS
pathways_database = msigdb_v6_2_with_orthologs

# Basic parameters
gene_names_column = "Gene"
species = "Mouse"
collections_to_include = c("CP:KEGG: KEGG gene sets","H: hallmark gene sets","C5: GO gene sets")
...
var_GSEA_Preranked<-GSEA_Preranked(var_ENTN803aPD1_vs_PBS,var_msigdb_v6_2_with_orthologs)
