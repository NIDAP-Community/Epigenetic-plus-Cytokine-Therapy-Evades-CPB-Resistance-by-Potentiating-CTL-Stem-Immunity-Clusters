...
SuppFIGURE_3C_TripletvsENTN803 <- function(DEGMarkers_CD8_GzmbposKi67neg) {
    # image: png
...
print("template_SuppFIGURE_3C_TripletvsENTN803.R #########################################################################")
...
var_SuppFIGURE_3C_TripletvsENTN803<-SuppFIGURE_3C_TripletvsENTN803(var_DEGMarkers_CD8_GzmbposKi67neg)
saveRDS(var_SuppFIGURE_3C_TripletvsENTN803, paste0(rds_output,"/var_SuppFIGURE_3C_TripletvsENTN803.rds"))
