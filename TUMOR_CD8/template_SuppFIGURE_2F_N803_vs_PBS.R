...
SuppFIGURE_2F_N803_vs_PBS <- function(DEGMarkers_Reclustered_CD8CD3) {
    # image: png
    ...
    label.col <- "Gene"
    sig.col <- c("C_N803_vs_PBS_pval")
    pCutoff  = 0.05
    lfc.col <- c("C_N803_vs_PBS_logFC")
    FCcutoff = 0.26303
    ...
    additional_labels <- "Lef1,Tcf7,ell,Foxp1,Klf2,Satb1"
    labSize <- 12    
...
print("template_SuppFIGURE_2F_N803_vs_PBS.R #########################################################################")
...
var_SuppFIGURE_2F_N803_vs_PBS<-SuppFIGURE_2F_N803_vs_PBS(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_2F_N803_vs_PBS, paste0(rds_output,"/var_SuppFIGURE_2F_N803_vs_PBS.rds"))
