...
SuppFIGURE_3C_N803vsPBS <- function(DEGMarkers_CD8_GzmbposKi67neg) {
    # image: png
...
print("template_SuppFIGURE_3C_N803vsPBS.R #########################################################################")
...
var_SuppFIGURE_3C_N803vsPBS<-SuppFIGURE_3C_N803vsPBS(var_DEGMarkers_CD8_GzmbposKi67neg)
saveRDS(var_SuppFIGURE_3C_N803vsPBS, paste0(rds_output,"/var_SuppFIGURE_3C_N803vsPBS.rds"))
