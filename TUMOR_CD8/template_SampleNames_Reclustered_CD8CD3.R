...
SampleNames_Reclustered_CD8CD3 <- function(ReclusterSO_CD8cd3) {
...
#image: png
    png(filename="SampleNames_Reclustered_CD8CD3.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_SampleNames_Reclustered_CD8CD3.R #########################################################################")
...
var_SampleNames_Reclustered_CD8CD3<-SampleNames_Reclustered_CD8CD3(var_ReclusterSO_CD8cd3)
saveRDS(var_SampleNames_Reclustered_CD8CD3, paste0(rds_output,"/var_SampleNames_Reclustered_CD8CD3.rds"))
