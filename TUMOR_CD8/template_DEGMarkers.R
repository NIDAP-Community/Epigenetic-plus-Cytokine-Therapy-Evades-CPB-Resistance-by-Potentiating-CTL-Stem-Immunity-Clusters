...
DEGMarkers <- function(ReclusteredSO_CD8Tcells,SampleNames_Reclustered,MetadataTable_Reclustered) {
...
var_DEGMarkers<-DEGMarkers(var_ReclusteredSO_CD8Tcells,var_SampleNames_Reclustered,var_MetadataTable_Reclustered)
