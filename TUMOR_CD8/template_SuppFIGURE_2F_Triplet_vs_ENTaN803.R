...
SuppFIGURE_2F_Triplet_vs_ENTaN803 <- function(DEGMarkers_Reclustered_CD8CD3) {
    # image: png
    ...
    #Basic Parameters:
    df.orig <- DEGMarkers_Reclustered_CD8CD3
    label.col <- "Gene"
    ...
    no_genes_to_label <- 20
    use_only_addition_labels <- TRUE
    additional_labels <- "Gzmb,Gzmk,Ccl5,Ccr7,Il1b,Cxcl2,Icos,Junb,Ly6a,Ctla4,Il7r,Prf1"
    labSize <- 12    

    #Title and Axis labels Parameters
    change_sig_name <- "p-value"
    change_lfc_name <- "log2FC"
    title <- "ENTN803aPD1 vs ENTN803"
    #subtitle <- ""
...
print("template_SuppFIGURE_2F_Triplet_vs_ENTaN803.R #########################################################################")
...
var_SuppFIGURE_2F_Triplet_vs_ENTaN803<-SuppFIGURE_2F_Triplet_vs_ENTaN803(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_2F_Triplet_vs_ENTaN803, paste0(rds_output,"/var_SuppFIGURE_2F_Triplet_vs_ENTaN803.rds"))
