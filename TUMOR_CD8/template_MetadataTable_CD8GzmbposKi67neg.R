...
MetadataTable_CD8GzmbposKi67neg <- function(ReclusterSO_CD8_GzmbposKi67neg) {
...
#image: png
    png(filename="MetadataTable_CD8GzmbposKi67neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_CD8GzmbposKi67neg.R #########################################################################")
...
var_MetadataTable_CD8GzmbposKi67neg<-MetadataTable_CD8GzmbposKi67neg(var_ReclusterSO_CD8_GzmbposKi67neg)
saveRDS(var_MetadataTable_CD8GzmbposKi67neg, paste0(rds_output,"/var_MetadataTable_CD8GzmbposKi67neg.rds"))
