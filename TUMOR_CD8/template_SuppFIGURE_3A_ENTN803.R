...
SuppFIGURE_3A_ENTN803 <- function(ReclusterSO_CD8cd3,SampleNames_Reclustered_CD8CD3) {
...
print("template_SuppFIGURE_3A_ENTN803.R #########################################################################")
...
var_SuppFIGURE_3A_ENTN803<-SuppFIGURE_3A_ENTN803(var_ReclusterSO_CD8cd3,var_SampleNames_Reclustered_CD8CD3)
saveRDS(var_SuppFIGURE_3A_ENTN803, paste0(rds_output,"/var_SuppFIGURE_3A_ENTN803.rds"))
