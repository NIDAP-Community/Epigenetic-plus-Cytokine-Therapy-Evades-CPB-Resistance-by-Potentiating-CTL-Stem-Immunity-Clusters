...
DualLabelSO_CD8CD3 <- function(CellTypesSO,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
...
print("template_DualLabelSO_CD8CD3.R #########################################################################")
...
var_DualLabelSO_CD8CD3<-DualLabelSO_CD8CD3(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_DualLabelSO_CD8CD3, paste0(rds_output,"/var_DualLabelSO_CD8CD3.rds"))
