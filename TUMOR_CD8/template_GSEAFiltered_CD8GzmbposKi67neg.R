...
GSEAFiltered_CD8GzmbposKi67neg <- function(GSEA_Preranked, msigdb_v6_2_with_orthologs ) {
...
print("template_GSEAFiltered_CD8GzmbposKi67neg.R #########################################################################")
...
var_GSEAFiltered_CD8GzmbposKi67neg<-GSEAFiltered_CD8GzmbposKi67neg(var_GSEA_Preranked,var_msigdb_v6_2_with_orthologs)
saveRDS(var_GSEAFiltered_CD8GzmbposKi67neg, paste0(rds_output,"/var_GSEAFiltered_CD8GzmbposKi67neg.rds"))
