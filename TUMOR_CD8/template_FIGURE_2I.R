...
FIGURE_2I <- function(DEGMarkers_Reclustered_CD8CD3) {
    # image: png
    ...
    additional_labels <- "Gzmf,Gzmc,Gzmd,Ccl5,Gzme,Gzmb,Ifitm1,Ifitm2"
    labSize <- 12    
...
var_FIGURE_2I<-FIGURE_2I(var_DEGMarkers_Reclustered_CD8CD3)
saveRDS(var_FIGURE_2I, paste0(rds_output,"/var_FIGURE_2I.rds"))
