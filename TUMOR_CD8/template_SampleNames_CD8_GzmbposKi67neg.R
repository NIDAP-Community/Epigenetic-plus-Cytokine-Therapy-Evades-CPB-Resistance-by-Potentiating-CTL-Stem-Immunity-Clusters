...
SampleNames_CD8_GzmbposKi67neg <- function(ReclusterSO_CD8_GzmbposKi67neg) {
...
#image: png
    png(filename="SampleNames_CD8_GzmbposKi67neg.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_SampleNames_CD8_GzmbposKi67neg.R #########################################################################")
...
var_SampleNames_CD8_GzmbposKi67neg<-SampleNames_CD8_GzmbposKi67neg(var_ReclusterSO_CD8_GzmbposKi67neg)
saveRDS(var_SampleNames_CD8_GzmbposKi67neg, paste0(rds_output,"/var_SampleNames_CD8_GzmbposKi67neg.rds"))
