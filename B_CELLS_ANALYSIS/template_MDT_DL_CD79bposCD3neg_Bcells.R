...
MDT_DL_CD79bposCD3neg_Bcells <- function(DualLabelSO_CD79bposCD3neg_Bcells) {
...
#image: png
    png(filename="MDT_DL_CD79bposCD3neg_Bcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MDT_DL_CD79bposCD3neg_Bcells.R #########################################################################")
...
var_MDT_DL_CD79bposCD3neg_Bcells<-MDT_DL_CD79bposCD3neg_Bcells(var_DualLabelSO_CD79bposCD3neg_Bcells)
saveRDS(var_MDT_DL_CD79bposCD3neg_Bcells, paste0(rds_output,"/var_MDT_DL_CD79bposCD3neg_Bcells.rds"))
