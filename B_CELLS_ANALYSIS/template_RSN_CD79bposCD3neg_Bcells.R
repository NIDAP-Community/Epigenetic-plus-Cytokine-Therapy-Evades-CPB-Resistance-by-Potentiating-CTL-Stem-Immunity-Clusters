...
RSN_CD79bposCD3neg_Bcells <- function(Reclustered_CD79bposCD3neg_Bcells) {
...
#image: png
    png(filename="RSN_CD79bposCD3neg_Bcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RSN_CD79bposCD3neg_Bcells.R #########################################################################")
...
var_RSN_CD79bposCD3neg_Bcells<-RSN_CD79bposCD3neg_Bcells(var_Reclustered_CD79bposCD3neg_Bcells)
saveRDS(var_RSN_CD79bposCD3neg_Bcells, paste0(rds_output,"/var_RSN_CD79bposCD3neg_Bcells.rds"))
