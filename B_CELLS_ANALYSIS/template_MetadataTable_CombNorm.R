...
MetadataTable_CombNorm <- function(CombNormSO) {
...
#image: png
    png(filename="MetadataTable_CombNorm.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MetadataTable_CombNorm.R #########################################################################")
...
var_MetadataTable_CombNorm<-MetadataTable_CombNorm(var_CombNormSO)
saveRDS(var_MetadataTable_CombNorm, paste0(rds_output,"/var_MetadataTable_CombNorm.rds"))
