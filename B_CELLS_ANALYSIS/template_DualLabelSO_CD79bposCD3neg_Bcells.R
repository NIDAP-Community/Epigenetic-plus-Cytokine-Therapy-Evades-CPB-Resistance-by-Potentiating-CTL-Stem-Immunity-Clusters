...
DualLabelSO_CD79bposCD3neg_Bcells <- function(CellTypesSO,SampleNames_CellTypes) {  # produces 2 color channels and the overlay
    ...
    marker_1_type <- "SCT"
    marker2 <- "Cd79b"
    marker_2_threshold <- 0.018
    marker_2_type <- "SCT"
    
    #Filter Parameters:
    filter_data <- TRUE
    parameter_name <- "Cd79b_Cd3eneg"
    marker.1.filter.direction <- "less than"
...
print("template_DualLabelSO_CD79bposCD3neg_Bcells.R #########################################################################")
...
var_DualLabelSO_CD79bposCD3neg_Bcells<-DualLabelSO_CD79bposCD3neg_Bcells(var_CellTypesSO,var_SampleNames_CellTypes)
saveRDS(var_DualLabelSO_CD79bposCD3neg_Bcells, paste0(rds_output,"/var_DualLabelSO_CD79bposCD3neg_Bcells.rds"))
