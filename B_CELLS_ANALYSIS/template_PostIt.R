...
#image: png
    png(filename="PostIt.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
var_PostIt<-PostIt()
saveRDS(var_PostIt, paste0(rds_output,"/var_PostIt.rds"))
