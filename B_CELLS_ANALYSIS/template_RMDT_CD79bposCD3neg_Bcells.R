...
RMDT_CD79bposCD3neg_Bcells <- function(Reclustered_CD79bposCD3neg_Bcells) {
...
#image: png
    png(filename="RMDT_CD79bposCD3neg_Bcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_RMDT_CD79bposCD3neg_Bcells.R #########################################################################")
...
var_RMDT_CD79bposCD3neg_Bcells<-RMDT_CD79bposCD3neg_Bcells(var_Reclustered_CD79bposCD3neg_Bcells)
saveRDS(var_RMDT_CD79bposCD3neg_Bcells, paste0(rds_output,"/var_RMDT_CD79bposCD3neg_Bcells.rds"))
