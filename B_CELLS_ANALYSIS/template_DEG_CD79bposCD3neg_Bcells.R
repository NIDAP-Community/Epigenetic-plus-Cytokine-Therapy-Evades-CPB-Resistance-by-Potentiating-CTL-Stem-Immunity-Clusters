...
DEG_CD79bposCD3neg_Bcells <- function(Reclustered_CD79bposCD3neg_Bcells,RSN_CD79bposCD3neg_Bcells,RMDT_CD79bposCD3neg_Bcells) {
    ...
    seurat_object <- Reclustered_CD79bposCD3neg_Bcells
    metadata_table <- RMDT_CD79bposCD3neg_Bcells
...
print("template_DEG_CD79bposCD3neg_Bcells.R #########################################################################")
...
# Processing input variable: var_Reclustered_CD79bposCD3neg_Bcells
var_Reclustered_CD79bposCD3neg_Bcells<-readRDS(paste0(rds_output,"/var_Reclustered_CD79bposCD3neg_Bcells.rds"))

if (!('Seurat' %in% class(var_Reclustered_CD79bposCD3neg_Bcells))) { if (!(class(var_Reclustered_CD79bposCD3neg_Bcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_Reclustered_CD79bposCD3neg_Bcells <- as.data.frame(var_Reclustered_CD79bposCD3neg_Bcells)}}
#############################


# Processing input variable: var_RSN_CD79bposCD3neg_Bcells
var_RSN_CD79bposCD3neg_Bcells<-readRDS(paste0(rds_output,"/var_RSN_CD79bposCD3neg_Bcells.rds"))

if (!('Seurat' %in% class(var_RSN_CD79bposCD3neg_Bcells))) { if (!(class(var_RSN_CD79bposCD3neg_Bcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RSN_CD79bposCD3neg_Bcells <- as.data.frame(var_RSN_CD79bposCD3neg_Bcells)}}
#############################


# Processing input variable: var_RMDT_CD79bposCD3neg_Bcells
var_RMDT_CD79bposCD3neg_Bcells<-readRDS(paste0(rds_output,"/var_RMDT_CD79bposCD3neg_Bcells.rds"))

if (!('Seurat' %in% class(var_RMDT_CD79bposCD3neg_Bcells))) { if (!(class(var_RMDT_CD79bposCD3neg_Bcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_RMDT_CD79bposCD3neg_Bcells <- as.data.frame(var_RMDT_CD79bposCD3neg_Bcells)}}
#############################

# Saving Output Dataset
invisible(graphics.off())
var_DEG_CD79bposCD3neg_Bcells<-DEG_CD79bposCD3neg_Bcells(var_Reclustered_CD79bposCD3neg_Bcells,var_RSN_CD79bposCD3neg_Bcells,var_RMDT_CD79bposCD3neg_Bcells)
saveRDS(var_DEG_CD79bposCD3neg_Bcells, paste0(rds_output,"/var_DEG_CD79bposCD3neg_Bcells.rds"))
