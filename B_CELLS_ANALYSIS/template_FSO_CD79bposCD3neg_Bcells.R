...
FSO_CD79bposCD3neg_Bcells <- function(DualLabelSO_CD79bposCD3neg_Bcells, MDT_DL_CD79bposCD3neg_Bcells, SampleNames_CellTypes) {
...
library(plotly)
    ...
    seurat_object <- DualLabelSO_CD79bposCD3neg_Bcells
    
    # Category parameters    
    category_to_filter <- "Cd79b_Cd3eneg"
    seed <- 10
...
print("template_FSO_CD79bposCD3neg_Bcells.R #########################################################################")
...
# Processing input variable: var_DualLabelSO_CD79bposCD3neg_Bcells
var_DualLabelSO_CD79bposCD3neg_Bcells<-readRDS(paste0(rds_output,"/var_DualLabelSO_CD79bposCD3neg_Bcells.rds"))

if (!('Seurat' %in% class(var_DualLabelSO_CD79bposCD3neg_Bcells))) { if (!(class(var_DualLabelSO_CD79bposCD3neg_Bcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_DualLabelSO_CD79bposCD3neg_Bcells <- as.data.frame(var_DualLabelSO_CD79bposCD3neg_Bcells)}}
#############################


# Processing input variable: var_MDT_DL_CD79bposCD3neg_Bcells
var_MDT_DL_CD79bposCD3neg_Bcells<-readRDS(paste0(rds_output,"/var_MDT_DL_CD79bposCD3neg_Bcells.rds"))

if (!('Seurat' %in% class(var_MDT_DL_CD79bposCD3neg_Bcells))) { if (!(class(var_MDT_DL_CD79bposCD3neg_Bcells) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_MDT_DL_CD79bposCD3neg_Bcells <- as.data.frame(var_MDT_DL_CD79bposCD3neg_Bcells)}}
#############################
...
var_FSO_CD79bposCD3neg_Bcells<-FSO_CD79bposCD3neg_Bcells(var_DualLabelSO_CD79bposCD3neg_Bcells,var_MDT_DL_CD79bposCD3neg_Bcells,var_SampleNames_CellTypes)
saveRDS(var_FSO_CD79bposCD3neg_Bcells, paste0(rds_output,"/var_FSO_CD79bposCD3neg_Bcells.rds"))
