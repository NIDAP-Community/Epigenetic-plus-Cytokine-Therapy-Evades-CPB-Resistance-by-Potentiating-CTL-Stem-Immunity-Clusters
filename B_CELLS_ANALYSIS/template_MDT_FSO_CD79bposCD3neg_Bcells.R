...
MDT_FSO_CD79bposCD3neg_Bcells <- function(FSO_CD79bposCD3neg_Bcells) {
...
#image: png
    png(filename="MDT_FSO_CD79bposCD3neg_Bcells.png", width=image_width, height=image_height,      units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_MDT_FSO_CD79bposCD3neg_Bcells.R #########################################################################")
...
var_MDT_FSO_CD79bposCD3neg_Bcells<-MDT_FSO_CD79bposCD3neg_Bcells(var_FSO_CD79bposCD3neg_Bcells)
saveRDS(var_MDT_FSO_CD79bposCD3neg_Bcells, paste0(rds_output,"/var_MDT_FSO_CD79bposCD3neg_Bcells.rds"))
